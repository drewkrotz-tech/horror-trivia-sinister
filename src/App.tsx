...
const Q1c1=[{q:"In what 1980 slasher does Jamie Lee Curtis play a high school student whose friends accidentally caused a child's death?",o:["Terror Train","The Fog","Prom Night","Roadgames"],a:2,d:1},{q:"What connects the films Freaky and Happy Death Day?",o:["Same director","Same studio","Same characters","Same killer"],a:0,d:1},{q:"What is the last thing Glen does before his death in A Nightmare on Elm Street?",o:["He falls asleep while listening to music on headphones watching TV","He sneaks out of the house to help Nancy set traps for Freddy Krueger","He stays up all night drinking coffee and watching monster movies with Nancy","He tells his parents about Freddy and begs them to let him sleep at Nancy's"],a:0,d:1},{q:"Why was Silent Night Deadly Night protested?",o:["It featured Santa Claus as a killer upsetting parents","It showed graphic nun torture scenes that offended Catholic groups","It was filmed at real shopping malls without any kind of permission","It depicted children witnessing murders in ways critics called abusive"],a:0,d:1},{q:"In Child's Play who made Chucky into a killer doll?",o:["Charles Lee Ray transferred his soul using voodoo","A factory worker cursed the doll as revenge on his boss","A satanic cult performed a ritual on a shipment of Good Guy dolls","Andy's mother bought the doll from a homeless man who warned her"],a:0,d:1},{q:"In Prom Night (1980) what is the connection between the killer and the victims?",o:["The victims accidentally caused a girl's death","The victims were all students the killer had dated before","They were witnesses to a crime the killer committed","All were cast members of the school play the killer missed"],a:0,d:1},{q:"In A Nightmare on Elm Street, what makes Nancy unique among horror heroines?",o:["Nancy moves from passive victim to active investigator","She is the first Final Girl to be based on a real true crime case","She uses martial arts training to fight the killer one on one","She is the only horror heroine who survives every film she appears in"],a:0,d:1},{q:"What is Dr. Lawrence Gordon's dilemma in Saw?",o:["Kill Adam to free himself","Saw off his own hand to escape","Drink poison to save his daughter","Choose which of his children dies"],a:0,d:1},{q:"What year was A Nightmare on Elm Street originally released?",o:["1981","1982","1984","1985"],a:2,d:1},{q:"In Nightmare on Elm Street, Freddy kills teens in their what?",o:["Nightmares","Bathrooms","Hot tub room","Garage"],a:0,d:1},{q:"In Freddy vs. Jason, why has Freddy lost his power?",o:["The children of Elm Street forgot about him","The town sealed his body in a secret underground crypt","Dream Warriors trapped him in the dream world permanently","Nancy's father destroyed his glove in a church fire ritual"],a:0,d:1},{q:"What slasher film has a killer called The Creeper?",o:["Jeepers Creepers","Crawlspace 1986","The Prowler 1981","Silent Scream 1979"],a:0,d:1},{q:"Who wrote the screenplay for The Burning?",o:["Peter Lawrence and Bob Weinstein","Brad Grey and Edward Pressman Jr","Tony Maylam and Brad Grey III","Sean Cunningham and Victor Miller"],a:0,d:1},{q:"What is Candyman's supernatural power?",o:["He is invisible", "He can only be summoned", "He can make people kill themselves", "He can possess people"],a:1,d:1},{q:"What happens if you feed a Mogwai after midnight in Gremlins?",o:["It transforms into a Gremlin","It grows to giant size and attacks","It dies instantly from toxic shock","It reproduces uncontrollably until dawn"],a:0,d:1},{q:"What is the name of the truck driver villain in Joy Ride 2001?",o:["Rusty Nail","Road Rage","Coyote","The Driver"],a:0,d:2},{q:"In what three slasher films does Jamie Lee Curtis star in 1980?",o:["Halloween II Prom Night and Terror Train","Prom Night Terror Train and The Fog","Halloween Prom Night and Carrie","Friday the 13th Prom Night and The Fog"],a:1,d:2},{q:"What is the Thanksgiving slasher released in 2023 directed by Eli Roth?",o:["Thanksgiving","Carver's Night","Plymouth Rot","Pilgrim's End"],a:0,d:1},{q:"What hospital does Jamie Lee Curtis' character work at in Halloween II?",o:["Haddonfield Memorial Hospital","Springfield General","Haddonfield Community","Laurie's hospital has no name"],a:0,d:2}];
const Q1c3=[{q:"What year was the Evil Dead remake released?",o:["2011", "2012", "2013", "2014"],a:2,d:1},{q:"What is Jason Voorhees' primary weapon?",o:["An axe", "A machete", "A chainsaw", "A hatchet"],a:1,d:1},{q:"What major twist ends the original Saw?",o:["The body in the room is Jigsaw himself","The detective was actually the killer all along","Dr. Gordon's daughter is revealed to be dead","Adam and Lawrence were never really strangers"],a:0,d:1},{q:"What is the main setting of Black Christmas (1974)?",o:["A sorority house", "A college dorm", "A high school", "A hospital"],a:0,d:1},{q:"What is the name of the detective who hunts Jigsaw in Saw?",o:["Eric Matthews", "David Tapp", "Peter Strahm", "Mark Hoffman"],a:1,d:1},{q:"What happens to Chucky in every film?",o:["He is always destroyed but always returns","He possesses a new doll body in each sequel","He escapes to a new town and begins again","He is captured then stolen by a new owner"],a:0,d:1}];
const Q1c4=[{q:"What is the name of the holiday horror film set at a ski resort?",o:["Cold Killer", "Iced", "Shredder", "Dead Snow"],a:3,d:1},{q:"In Friday the 13th what is the Crystal Lake nickname that locals use?",o:["Lake of Blood", "Camp Blood", "Crystal Death", "The Cursed Lake"],a:1,d:1},{q:"Who seeks revenge in Prom Night (1980)?",o:["A survivor of the accident", "The dead girl's brother", "The dead girl's father", "The dead girl herself"],a:1,d:1},{q:"What is the name of the killer in The Collector (2009)?",o:["The Collector", "John Doe", "He is unnamed", "The Surgeon"],a:0,d:1},{q:"What does Evil Dead Rise's bloodfall sequence involve?",o:["A ceiling of blood flooding a corridor","A sprinkler system activated with blood","A bathtub overflowing with blood onto a child","A flooded elevator shaft filled with fresh blood"],a:0,d:1}];
const Q1c5=[{q:"What is the main antagonist's name in The People Under the Stairs?",o:["The Man and The Woman","The Landlord and Roach","Daddy and Mommy Robeson","The Father and The Tenant"],a:0,d:1},{q:"In Friday the 13th what is unusual about the film compared to its sequels?",o:["Mrs. Voorhees is the killer","There is no masked slasher villain","Jason Voorhees never appears onscreen","The film takes place at a boarding school"],a:0,d:1},{q:"In Evil Dead (1981), what awakens the demons in the woods?",o:["Playing a tape recording of incantations from the Necronomicon Ex-Mortis","Reading the Necronomicon aloud at midnight while holding the cursed dagger","Sacrificing a small animal on the cabin's stone altar after finding the book","Cutting their hand and spilling blood on the pages of the leather-bound book"],a:0,d:1},{q:"In Sleepaway Camp what is Angela's occupation at the camp?",o:["She is a camper","A camp counselor","A kitchen helper","A swimming coach"],a:0,d:1},{q:"What 2023 slasher is the third film in Ti West's X trilogy?",o:["Z","MaXXXine","After X","Beyond Pearl"],a:1,d:1},{q:"What is the name of the pig mask in Saw?",o:["The Jigsaw Pig", "The Reverse Sow", "Amanda's mask", "The Pig Mask"],a:3,d:1},{q:"Who directed the Evil Dead remake (2013)?",o:["Fede Álvarez","Diederik Van Rooij","Adam Robitel Jr","Leigh Whannell"],a:0,d:1},{q:"What holiday is associated with the killer in My Bloody Valentine?",o:["Valentine's Day","Thanksgiving Day","Independence Day","St Patrick's Day"],a:0,d:1},{q:"What is the name of the protagonist in the original Nightmare on Elm Street?",o:["Kristen Parker", "Alice Johnson", "Nancy Thompson", "Heather Langenkamp"],a:2,d:1},{q:"What slasher features an Asian American Final Girl?",o:["Happy Death Day", "X", "The Slumber Party Massacre", "Chopping Mall"],a:1,d:1},{q:"In My Bloody Valentine (1981), what event is the film set around?",o:["Valentine's Day dance","Anniversary of mine deaths","Homecoming king coronation","Graduation day celebration"],a:0,d:1},{q:"In Nightmare on Elm Street what happens to Glen Lantz?",o:["He is dragged into his bed in a geyser of blood","He is stabbed repeatedly through his bedroom window","He is decapitated in a bathtub while Nancy sleeps","He is crushed between the walls of his closet door"],a:0,d:1},{q:"What 1981 slasher features a killer who targets students on their birthdays?",o:["Happy Birthday to Me","Birthday Party Blood","Slice of Birthday","The Birthday Killer"],a:0,d:1},{q:"What weapon does the killer use in I Know What You Did Last Summer?",o:["A fishing hook","A meat hook","A hay hook","A captain's hook"],a:0,d:1},{q:"In Nightmare on Elm Street what does Tina's boyfriend Rod do after her death?",o:["He becomes the next victim","He confesses to the police","He escapes and flees town","He tries to warn Nancy"],a:0,d:1},{q:"In Happy Death Day 2U, what does Tree discover about the alternate timeline?",o:["Her mother is still alive","She never existed in it","The killer is different","Carter doesn't know her"],a:0,d:1},{q:"In Happy Death Day what day does Tree keep reliving?",o:["Halloween", "Her birthday", "Friday the 13th", "The anniversary of her mother's death"],a:1,d:1},{q:"How do you summon the Candyman?",o:["Say his name once in a mirror","Say his name five times in a mirror","Light a candle and say his name","Look into a mirror at midnight"],a:1,d:1},{q:"What slasher franchise is set in New Orleans bayou country?",o:["Wrong Turn", "Friday the 13th", "Hatchet", "The Bayou Slasher"],a:2,d:1}];
const Q1c14=[{q:"In The Texas Chain Saw Massacre who survives besides Sally?",o:["Everyone but Franklin", "No one", "Jerry and Sally", "Pam and Sally"],a:1,d:1},{q:"In Child's Play, how does Charles Lee Ray transfer his soul into Chucky?",o:["Voodoo ritual","A blood pact","A hex spell","A curse tome"],a:0,d:1},{q:"Who was Michael Myers' first victim?",o:["Annie Brackett", "Lynda van der Klok", "Judith Myers", "Laurie Strode"],a:2,d:1},{q:"In Saw, where are the two men chained?",o:["A warehouse", "A bathroom", "A basement", "A garage"],a:1,d:1},{q:"In Texas Chain Saw what does Leatherface use to lure victims?",o:["He does not lure them","He uses a hitchhiking act","He mimics a car breakdown","He leaves a trail of meat"],a:0,d:1},{q:"What urban legend opens the film Urban Legend?",o:["The hook man", "The killer in the backseat", "Aren't you glad you didn't turn on the light", "The babysitter and the man upstairs"],a:1,d:1},{q:"Who is the main villain in the Saw franchise?",o:["The Collector", "John Kramer", "Art Blank", "Dr. Lawrence Gordon"],a:1,d:1},{q:"What slasher features kills at a high school reunion?",o:["Slaughter High", "Prom Night", "Happy Birthday to Me", "Class Reunion"],a:0,d:1},{q:"Who directed The Purge?",o:["James DeMonaco", "Wes Craven", "Jordan Peele", "Mike Flanagan"],a:0,d:1}];
const Q1c23=[{q:"What slasher film features a killer who works at an amusement park?",o:["The Funhouse (1981)","Carnival of Souls","Clownhouse (1989)","Dark Ride (2006)"],a:0,d:1},{q:"Who stars in My Bloody Valentine 3D (2009)?",o:["Jensen Ackles", "Ryan Reynolds", "Jared Padalecki", "Chris Pine"],a:0,d:1},{q:"What is Jason's father's name?",o:["Elias Voorhees", "Frank Voorhees", "Roy Voorhees", "His father is never mentioned"],a:0,d:1},{q:"What weapon does the killer use in Prom Night (1980)?",o:["Glass shard","Ice pick","Fire axe","Cleaver"],a:0,d:1},{q:"What is Jason Voorhees' mother's weapon of choice?",o:["Machete", "Knife", "Axe", "Hunting knife"],a:1,d:1},{q:"What is the killer's backstory in Cold Prey 2006?",o:["A deformed child left to die in the mountains who survived","An escaped convict from the Norwegian prison camp nearby","A hotel owner who lost his family in a winter avalanche","A park ranger driven mad by years of total isolation alone"],a:0,d:2},{q:"What makes Happy Death Day unique among slasher films?",o:["A time loop death and rebirth mechanic","A final girl who is secretly the killer","A body swap between victim and killer","A killer who can be seen only in mirrors"],a:0,d:1},{q:"What famous prop appears at the end of Jason Goes to Hell?",o:["The Necronomicon", "Freddy Krueger's glove", "The Lament Configuration", "Michael Myers' mask"],a:1,d:1}];
const Q1c29=[{q:"What slasher film features a killer who is a mall Santa?",o:["Silent Night Deadly Night","Christmas Evil (1980 film)","To All A Good Night 1980","Don't Open Till Christmas"],a:0,d:1},{q:"What is the production company logo that opens most Blumhouse films?",o:["The Blumhouse logo with a sinister looking B","A child's hand reaching for a door handle slowly","An animated skull fading into the company name","A camera shutter closing over a dark hallway scene"],a:0,d:1},{q:"What is the killer's gimmick in Happy Death Day?",o:["He only kills on birthdays", "Tree relives her murder day on loop", "He sends death threats first", "He kills in alphabetical order"],a:1,d:1},{q:"In Graduation Day, what sport connects all the victims?",o:["Track and field","Football team","Baseball team","Swim team"],a:0,d:1},{q:"In I Know What You Did Last Summer, what do the teens hit with their car?",o:["A dog", "A man", "A deer", "A child"],a:1,d:1}];
const Q1c31=[{q:"What is Jason Blum's company called?",o:["Blumhouse", "Blum Studios", "Jason Films", "Blum Productions"],a:0,d:1},{q:"What slasher franchise had the longest gap between sequels?",o:["Halloween", "Friday the 13th", "Nightmare on Elm Street", "Scream"],a:0,d:1},{q:"What slasher film was shot on video for around $40,000 making it one of the cheapest ever made?",o:["Sledgehammer","Blood Harvest","Boarding House","Video Violence"],a:0,d:1},{q:"What slasher film is set during Mardi Gras?",o:["Mardi Gras Massacre","Carnival of Blood","The Fat Tuesday Killer","Beads of the Damned"],a:0,d:1},{q:"What slasher film series is set in Springwood?",o:["A Nightmare on Elm Street","Friday the 13th franchise","Halloween film franchise","Child's Play franchise"],a:0,d:1},{q:"What was the first slasher film to win an Academy Award?",o:["Silence of the Lambs","Psycho by Hitchcock","Halloween by Carpenter","The Exorcist 1973"],a:0,d:1},{q:"What slasher features characters trapped in a corn maze?",o:["Children of the Corn", "Maize", "The Maze", "Children of the Corn: Genesis"],a:2,d:1},{q:"Who plays Leatherface in the 2022 Netflix sequel?",o:["Mark Burnham", "Andrew Bryniarski", "R.A. Mihailoff", "Bill Johnson"],a:0,d:1},{q:"What does the Jigsaw killer always leave at crime scenes?",o:["A jigsaw puzzle piece","A bloodied chess pawn","A torn tarot card","A cassette tape"],a:0,d:1},{q:"What is John Kramer's philosophy about his victims?",o:["They don't appreciate life and need to earn it","They are all criminals who escaped real justice","They deserve to die for the sins they committed","They need to suffer to understand true forgiveness"],a:0,d:1},{q:"What city is Child's Play set in?",o:["New York", "Los Angeles", "Chicago", "Detroit"],a:2,d:1}];
const Q1c38=[{q:"What 1983 Canadian slasher features women auditioning for a director's film?",o:["Terror Train","Prom Night","Curtains","Happy Birthday to Me"],a:2,d:2},{q:"What slasher franchise features a killer called The Grabber?",o:["The Black Phone","The Sitter 2011","Grabber's Basement","The Vanishing 1988"],a:0,d:1},{q:"What slasher film features a killer who writes in blood on mirrors?",o:["The Bloody Mirror Killer", "Blood Night", "Happy Birthday to Me", "Bloody Mirror"],a:2,d:1},{q:"Who stars in Happy Birthday to Me?",o:["Glenn Ford and Melissa Sue Anderson","Donald Pleasence and Jamie Lee Curtis","Vincent Price and Olivia Hussey Fuller","Christopher Lee and Morgan Fairchild Ryan"],a:0,d:1},{q:"Who plays the hero in the original Texas Chain Saw Massacre?",o:["Sally Hardesty","Jenny Franklin","Karen Sawyer","Erin Hartley"],a:0,d:1},{q:"What is the English title of the Norwegian slasher Frostbitten?",o:["Cold Kill", "Ice Blood", "Frostbite", "Arctic Terror"],a:2,d:1},{q:"Whose short story is The Black Phone based on?",o:["Stephen King","Joe Hill","Dean Koontz","Scott Derrickson"],a:1,d:1}];
...
const Q1c43=[{q:"What is the premise of The Purge?",o:["One night a year all crime is legal","Masked killers invade homes on New Year","A cult kills one person per home each year","Survivors must compete in a televised hunt"],a:0,d:1},{q:"What 2019 film features a killer who runs a haunted house?",o:["Haunt", "Haunter", "Haunt House", "Dark Carnival"],a:0,d:1},{q:"What is the name of the final girl in the original Texas Chain Saw Massacre?",o:["Sally Hardesty","Kathy Spellman","Erin Hartley","Jenny Green"],a:0,d:1},{q:"What is the name of the ship the killer uses in I Know What You Did Last Summer?",o:["The Fisherman", "Blue Chipper", "Helen's Pride", "Nancy Drew"],a:1,d:1},{q:"What hockey mask does Jason Voorhees wear starting in which film?",o:["Friday the 13th Part 2", "Friday the 13th Part 3", "Friday the 13th: The Final Chapter", "Jason Lives"],a:1,d:1}];
const Q1c49=[{q:"What does Jason Voorhees wear before getting his hockey mask?",o:["A burlap sack","A pillowcase","A clown mask","A ski mask"],a:0,d:1},{q:"In You're Next, what is the heroine's special skill?",o:["She was raised in a survivalist compound","She served two tours as a combat medic","She trained for years in mixed martial arts","She worked undercover as a police detective"],a:0,d:1},{q:"What does Ghostface do while waiting for victims to answer horror trivia?",o:["He hides inside the house", "He circles the victim's house", "He watches from a car", "He cuts the power"],a:0,d:1},{q:"What is the famous set piece in Evil Dead Rise?",o:["A shower of blood from the ceiling","A cheese grater attack in a kitchen","An elevator filling with boiling blood","A chainsaw fight in a hallway landing"],a:0,d:1},{q:"In Black Christmas (1974) who is the caller revealed to be?",o:["It is never revealed","A sorority alumnus","The house janitor","A jilted ex lover"],a:0,d:1}];
const Q1c54=[{q:"What was the working title of The Texas Chain Saw Massacre?",o:["Head Cheese", "Leatherface", "The Sawyer Family", "Chainsaw Charlie"],a:0,d:1},{q:"What does the killer wear in You're Next?",o:["A clown mask", "Animal masks", "A Ghostface mask", "A skull mask"],a:1,d:1},{q:"What is the killer's catchphrase in Happy Death Day?",o:["Happy death day to you","Many happy returns die","Make a wish and bleed","Blow the candles out now"],a:0,d:1},{q:"What color is the iconic Ghostface mask?",o:["White", "Grey", "Pale yellow", "Bone white"],a:0,d:1},{q:"How many times must you say Candyman in the mirror?",o:["3", "4", "5", "7"],a:2,d:1},{q:"In The Burning how does Cropsy kill at the raft?",o:["He uses garden shears to kill multiple victims at once","He sets the wooden raft on fire while campers sleep","He drags swimmers underwater with a rusted iron chain","He overturns the raft and drowns them one by one in water"],a:0,d:1},{q:"What setting appears most frequently in classic 1980s slasher films?",o:["Summer camps and rural cabins","Big city alleyways and rooftops","Suburban malls and parking lots","Hospitals and nursing homes only"],a:0,d:1},{q:"In A Nightmare on Elm Street, what does Nancy's mother reveal about Freddy?",o:["That she kept his razor glove hidden in their basement furnace","That she was one of the vigilantes who burned Freddy alive decades ago","That Nancy's father killed Freddy in secret without telling the police","That Freddy visited Nancy as a child and she had blocked the memory out"],a:0,d:2},{q:"What does water symbolize in A Nightmare on Elm Street's dream sequences?",o:["Water consistently appears at moments of transition between dream and reality","Water is used by Craven to signal which characters Freddy has already chosen to target","Water represents Nancy's subconscious guilt over her mother's role in Freddy's death","Water in the film was an intentional visual homage to Craven's Last House on the Left film"],a:0,d:3},{q:"What is the famous shower scene victim's name in Psycho?",o:["Lila Crane", "Mary Crane", "Marion Crane", "Lisa Crane"],a:2,d:1},{q:"What is the killer's name in The Burning?",o:["Cropsy","Victor","Tommy","Carl"],a:0,d:1},{q:"How does Cropsy get his injuries in The Burning?",o:["A fire set by campers as a prank","A lake accident during a storm","A chemical fire at the mess hall","A hunting accident in the woods"],a:0,d:1},{q:"What weapon does Cropsy use in The Burning?",o:["Garden shears","A long machete","A fire axe","A sickle"],a:0,d:1},{q:"Where is Black Christmas 1974 set?",o:["A sorority house","A school dormitory","A family cabin home","An apartment block"],a:0,d:1},{q:"Where is My Bloody Valentine 1981 set?",o:["A coal mining town","A small port village","A lumberjack camp","A dairy farm town"],a:0,d:1},{q:"In My Bloody Valentine what event did the mining disaster interrupt?",o:["A Valentine's Day dance","A miner's union meeting","A church confirmation","A high school reunion"],a:0,d:1},{q:"What weapon does the killer use in My Bloody Valentine?",o:["A pickaxe","A shovel","A drill","A chainsaw"],a:0,d:1},{q:"What is the famous twist ending of Sleepaway Camp?",o:["Angela is revealed to be biologically male","Angela has been dead the whole film already","The camp director was the one behind it all","Angela is possessed by her dead brother Peter"],a:0,d:1},{q:"What does the killer leave as a warning in My Bloody Valentine?",o:["A box of chocolates containing a human heart","A valentine card written in the victim's blood","A rose bouquet with severed fingers hidden inside","A bloody locket with a photo of the dead victim"],a:0,d:1},{q:"What is the premise of It Follows?",o:["A supernatural entity is passed through sexual contact and slowly follows its target","A group of college kids triggers a curse by breaking into an abandoned Detroit building at night","A woman inherits a haunted house and must pass its curse to a living person to survive the year","A chain letter curse must be forwarded to new victims or the recipient dies exactly one week later"],a:0,d:1},{q:"What do the killers in The Strangers say when asked why they attacked?",o:["You were home","Because you were there","We wanted to","You had something we wanted"],a:0,d:1},{q:"What country is Wolf Creek set in?",o:["Canada","New Zealand","Australia","South Africa"],a:2,d:1},{q:"What is the killer's name in Wolf Creek?",o:["Paul Hogan","Mick Taylor","Jack Wade","Barry Clifford"],a:1,d:1},{q:"What makes the final girl in You're Next uniquely formidable?",o:["She grew up on a survivalist compound","She was formerly a homicide detective","She trained in Krav Maga for ten years","She worked as a wilderness survival guide"],a:0,d:1},{q:"What masks do the killers wear in You're Next?",o:["Clown masks","Animal masks","Hockey masks","Halloween masks"],a:1,d:1},{q:"What is the famous twist in Orphan 2009?",o:["Esther is actually a 33-year-old woman with a disorder that stunts her growth","Esther is the adopted sister's real biological daughter returning to reclaim her rightful home","Esther was the product of a twin experiment where her sibling died and her identity was stolen","Esther has been possessed by the vengeful spirit of a girl who was murdered in the same orphanage"],a:0,d:1},{q:"What is the killer's name in the Hatchet series?",o:["Victor Crowley","Harry Warden","Madman Marz","Roy Burns Jr"],a:0,d:1},{q:"What is unique about the killer in Final Destination?",o:["Death itself is the antagonist","A ghost seeking revenge appears","A serial killer stalks survivors","A cursed object hunts the teens"],a:0,d:1},{q:"How does the first Final Destination begin?",o:["A premonition about a plane explosion","A vision of a highway pile up disaster","A prediction of a roller coaster derailing","A warning about a burning office building"],a:0,d:1},{q:"What does the term final girl refer to in slasher films?",o:["The sole female survivor who confronts the killer","The last woman killed by the slasher in each film","The female character who seduces the killer to die","The virginal love interest who dies last in the film"],a:0,d:1},{q:"What real life killer inspired Texas Chain Saw Massacre?",o:["Ted Bundy","Jeffrey Dahmer","Ed Gein","John Wayne Gacy"],a:2,d:1},{q:"Who stars in I Know What You Did Last Summer?",o:["Jennifer Love Hewitt and Sarah Michelle Gellar","Neve Campbell and Courteney Cox Arquette III","Reese Witherspoon and Alicia Silverstone Ryan","Jennifer Lopez and Cameron Diaz Kennedy Jones"],a:0,d:1},{q:"What was Rob Zombie's directorial debut?",o:["House of 1000 Corpses","The Devil's Rejects II","31 A Zombie Picture","Halloween II Remake"],a:0,d:1},{q:"What is the name of the killer family in Rob Zombie's films?",o:["The Firefly family","The Sawyer clan kin","The Maniac family","The Crowley family"],a:0,d:1},{q:"Who stars in Ready or Not 2019?",o:["Margot Robbie","Samara Weaving","Elizabeth Olsen","Anya Taylor-Joy"],a:1,d:1},{q:"Who stars in Prom Night 1980?",o:["Sissy Spacek","Jamie Lee Curtis","Brooke Shields","Carrie Fisher"],a:1,d:1},{q:"What is the name of the 2022 prequel to X?",o:["XX","Maxine","Pearl","Rose"],a:2,d:1},{q:"Who plays the title character in Pearl 2022?",o:["Mia Goth","Jenna Ortega","Anya Taylor-Joy","Florence Pugh"],a:0,d:1},{q:"What are the killers in Wrong Turn?",o:["Inbred cannibalistic mutants","Radioactive mountain hermits","Escaped mental patients nearby","Survivalist cult members armed"],a:0,d:1},{q:"Who plays Victor Crowley in the Hatchet films?",o:["Kane Hodder","Doug Bradley","Tyler Mane","Ken Kirzinger"],a:0,d:1},{q:"What 1960 Hitchcock film is considered a proto-slasher?",o:["The Birds","Vertigo","Psycho","Rear Window"],a:2,d:1},{q:"What do the teens cover up in I Know What You Did Last Summer?",o:["Hitting and killing a fisherman with their car","Causing a drunken drowning at the prom party","Robbing a gas station that ended up with death","Accidentally burning down a classmate's lake home"],a:0,d:1},{q:"Who plays Art the Clown in the Terrifier films?",o:["David Howard Thornton","Bill Skarsgard Junior","Tim Curry in makeup","Doug Jones the Third"],a:0,d:1},{q:"In Mike Flanagan's Hush, what makes the final girl unique?",o:["She is deaf and mute","She is totally blind","She is in a wheelchair","She is a child aged ten"],a:0,d:1},{q:"What character does Sid Haig play in House of 1000 Corpses?",o:["Captain Spaulding","Otis B Driftwood","Dr Satan Coltrane","Rufus Firefly Sr"],a:0,d:1},{q:"Where is The Funhouse set?",o:["A traveling carnival","A boardwalk arcade","An amusement park","A seasonal fairground"],a:0,d:1},{q:"What is the premise of Fresh 2022?",o:["A woman discovers her new boyfriend harvests and sells human meat","A family is hunted for sport by wealthy guests at a wedding retreat","A woman is stalked by her obsessive ex from across her apartment hall","Cannibalistic neighbors lure women through a dating app in a small town"],a:0,d:1}];
const Q2c0=[{q:"In Terrifier, what is Art the Clown's specific performance style?",o:["Art is specifically a mime-clown hybrid who never speaks","Art was originally designed as a traditional rodeo style clown","Art was based on an old 1970s New York street performer act","Art was conceived to parody the circus clown Krusty from TV shows"],a:0,d:1},{q:"What does Chop-Top keep doing throughout Texas Chain Saw Massacre 2?",o:["Scratching his metal skull plate with a heated coat hanger and eating the burnt skin residue","Constantly singing Vietnam War protest songs while miming a chainsaw dance in the hideout's kitchen","Compulsively drawing portraits of Leatherface on the walls while whispering in a made up language","Reciting long passages from the Texas state penal code to his family members during every meal time"],a:0,d:2},{q:"What does Freddy Krueger's glove have on the finger tips in the original?",o:["Metal razors formed into claws","Four butcher knives soldered in place","Sharpened garden shear blades welded on","Hand hammered steel spikes and barbed wire"],a:0,d:2},{q:"What city is Candyman: Farewell to the Flesh set in?",o:["New Orleans","Savannah GA","Baton Rouge","Charleston"],a:0,d:2},{q:"Who is the legend that Madman is based on?",o:["Cropsy", "Madman Marz", "The Ripper", "Billy the Kid"],a:1,d:2},{q:"In Halloween II what specific location becomes the film's primary horror space?",o:["Haddonfield Memorial Hospital","The abandoned Myers house nearby","Smith's Grove Sanitarium wards","Haddonfield High School campus"],a:0,d:2},{q:"What does Jigsaw say is the reason he puts people through traps?",o:["So they will appreciate life","To punish criminals properly","To entertain a secret audience","For his own twisted amusement"],a:0,d:2},{q:"What rating did Terrifier receive from the MPAA?",o:["Unrated","NC-17","R+","PG-13"],a:0,d:2},{q:"In Halloween why does Michael specifically return to Haddonfield?",o:["To kill Dr. Loomis", "To find and kill his sister", "To return home to the Myers house", "To escape the sanitarium territory"],a:1,d:2},{q:"In Friday the 13th Part 2 what specific action does Ginny take that shows?",o:["She puts on Pamela Voorhees' sweater and calls to Jason as if she were his mother to distract him","She rigs the cabin with gasoline and matches to burn Jason alive while he hunts her inside the building","She hides beneath the rotting floorboards of the cabin and waits patiently for Jason to pass overhead","She impersonates Alice from the original film and lures Jason into a trap near the original Crystal Lake"],a:0,d:2}];
const Q2c1=[{q:"Who dies first in Child's Play 1988?",o:["Charles Lee Ray","Eddie Caputo Jr","Maggie Peterson","Mike Norris II"],a:0,d:2},{q:"What was the first major film featuring a family of killers?",o:["The Texas Chain Saw Massacre","The Hills Have Eyes (1977)","House of 1000 Corpses film","Mother's Day Troma feature"],a:0,d:2},{q:"In the Return to Sleepaway Camp film, who plays Angela?",o:["Felissa Rose reprising the role","Pamela Springsteen returning","Vincent Pastore plays Angela","A brand new unknown actress"],a:0,d:2},{q:"In Nightmare on Elm Street 3 what is Phillip's dream power?",o:["He can turn his veins into marionette strings to control his movements — Freddy uses this against him","He can levitate and fly through the dreamscape — Freddy counters this by flooding the entire dream realm","He can shapeshift into animal forms at will — Freddy uses this against him by forcing a permanent change","He can see the future of his friends' deaths — Freddy exploits this by corrupting every vision he receives"],a:0,d:2},{q:"What does the killer in Maniac collect?",o:["Fingers", "Scalps", "Eyes", "Ears"],a:1,d:2},{q:"What is the name of the main protagonist in Jason Goes to Hell?",o:["Tommy Jarvis", "Steven Freeman", "Roy Burns", "Creighton Duke"],a:1,d:2},{q:"What Friday the 13th franchise decision about the hockey mask's design created?",o:["A random prop", "The specific red chevron marks on the hockey mask", "A custom mask was built", "The mask was found on set"],a:0,d:2},{q:"Who plays Crowley's father in the original Hatchet backstory?",o:["Tony Todd", "Robert Englund", "John Carl Buechler", "Derek Mears"],a:1,d:2}];
const Q2c2=[{q:"In Happy Death Day, what day does Tree keep reliving?",o:["Halloween","Her birthday","Friday the 13th","The anniversary of her mother's death"],a:1,d:1},{q:"What slasher franchise has the most sequels ever made?",o:["Halloween","Friday the 13th","A Nightmare on Elm Street","Hellraiser"],a:3,d:1},{q:"What slasher is set at a haunted hotel and features a writer slowly going mad?",o:["The Shining","Room 1408","Identity 02","Hotel Hell"],a:0,d:1},{q:"What is the Texas Chain Saw Massacre's famous opening claim?",o:["The film presents itself as based on real events","The narrator says the killings were never solved","An on-screen date claims August 18th of a year ago","The text claims it was filmed at the actual crime scene"],a:0,d:1},{q:"What is the sequel to Child's Play called?",o:["Child's Play 2","Son of Chucky","Killer Doll II","Chucky Strikes"],a:0,d:2},{q:"Who plays Winslow Foxworth Coltrane in 3 From Hell?",o:["Richard Brake", "Jeff Daniel Phillips", "Bill Moseley", "Pancho Moler"],a:0,d:2}];
const Q2c3=[{q:"Who made the original Freddy glove prop?",o:["Wes Craven personally designed and built it himself in his garage before production began","Lou Carlucci built the glove working from rough sketches that Wes Craven provided before filming began","Robert Englund commissioned a local metalworker to build it based on what he imagined the weapon to be","Jim Doyle designed and constructed it after weeks of trial runs with different blade shapes and lengths"],a:0,d:2},{q:"How many kills does Chucky have in Child's Play 1988?",o:["2", "3", "4", "5"],a:2,d:2},{q:"What does Freddy say in Nightmare on Elm Street 4 when he kills Debbie?",o:["Welcome to the jungle", "What a rush", "No pain no gain", "Bodies in motion"],a:2,d:2},{q:"What does Tommy Jarvis do to distract Jason in The Final Chapter?",o:["He shaves his head and calls Jason's name to confuse him","He dresses in his dead sister's clothes and mimics her voice","He plays a recording of Pamela Voorhees through cabin speakers","He sets off homemade explosives in a rhythm to lure Jason in"],a:0,d:2}];
const Q2c4=[{q:"What does Nancy's father do for a living in Nightmare on Elm Street?",o:["He is a police officer","He is a school teacher","He is a firefighter chief","He is a county doctor"],a:0,d:2},{q:"What does Final Girl mean in terms of horror convention?",o:["The last survivor who defeats the killer","The virginal last woman to die in the film","The female killer who was hiding all along","The last girl the killer successfully murders"],a:0,d:2},{q:"What color robe does Ghostface wear?",o:["Black", "Black with a white trim", "Pure black", "A dark navy"],a:0,d:2},{q:"What is Freddy's catchphrase before killing Jennifer in ANOES 3?",o:["Lights camera action", "Welcome to prime time bitch", "Say goodnight to the bad guy", "This is your final scene"],a:1,d:2},{q:"How much did Terrifier 2 gross at the box office?",o:["Over $10 million","Over $2 million","Over $25 million","Over $50 million"],a:0,d:2},{q:"What year was 3 From Hell released?",o:["2018", "2019", "2020", "2021"],a:1,d:2}];
const Q2c5=[{q:"What is the killer's costume in Happy Death Day?",o:["A pumpkin mask", "A clown costume", "A baby face mask", "A hockey mask"],a:2,d:2},{q:"What was the working title of Jigsaw (2017)?",o:["Saw VIII", "Saw: Legacy", "Jigsaw Returns", "Saw Reborn"],a:1,d:2},{q:"Why are Freddy's colors red and green?",o:["Wes Craven chose them", "It was an accident", "Robert Englund chose them", "The studio suggested them"],a:0,d:2},{q:"In Child's Play 2, where does Chucky track Andy?",o:["His foster family's home","An orphanage and school","A psychiatric hospital","His grandmother's farm"],a:0,d:2},{q:"What is the name of Freddy's father in the Nightmare mythology?",o:["He has no known father", "The villain Freddy references his father as the man of a hundred maniacs — he was never given a proper name", "The Dream Demon gave him life", "Frederick Krueger Sr."],a:0,d:2},{q:"In The Texas Chain Saw Massacre what does the hitchhiker do in the van?",o:["He cuts himself and Mark and is thrown out","He attacks the driver with a sharpened knife","He tries to steal the keys while they are driving","He sings disturbing songs until they pull over fast"],a:0,d:2}];
const Q2c9=[{q:"What is Amanda's fatal flaw according to Jigsaw?",o:["She is too violent", "She sets inescapable traps", "She gets too close to victims", "She is cowardly"],a:1,d:2},{q:"How does John Carpenter show Michael watching Laurie without her knowledge in Halloween?",o:["Deep focus shots with Michael lurking in the background","Close up tracking shots of Michael's eyes through windows","POV shots from Michael's perspective across the whole film","Rapid cuts between Michael's face and Laurie's at key beats"],a:0,d:2},{q:"What is the controversial implication of the Michael/Jamie psychic connection?",o:["It suggests Michael has emotional ties","It proves a supernatural cult connection","It shows Jamie is actually Michael's twin","It means Laurie secretly shared the link"],a:0,d:2},{q:"What does Freddy need to come back to power in Freddy vs. Jason?",o:["New victims", "Fear", "A blood sacrifice", "His glove"],a:1,d:2}];
const Q2c17=[{q:"How does Jason get his hockey mask in Friday the 13th Part 3?",o:["He takes it from Shelly after killing him","He finds it buried in a barn loft trunk","A girl throws it at him during her escape","He wears it through the entire film's scenes"],a:0,d:2},{q:"What 1984 slasher features a killer at a New Year's Eve party at a department?",o:["New Year's Evil", "Bloodbath", "Store of Terror", "Midnight Massacre"],a:0,d:2},{q:"How does Jason board the ship in Part VIII?",o:["He walks from the lake bottom","He is shipped aboard as cargo","He swims onto the boat's hull","He stows away on the dock"],a:0,d:2},{q:"How was Cropsy burned in The Burning?",o:["Campers placed a rotting worm-covered skull with candles beside his bed as a prank — he woke in panic","A cabin grease fire started while Cropsy was sleeping inside during his shift as the camp's maintenance head","A lantern overturned on his bunk during a storm and spilled kerosene across the bedding while he was asleep","A lit cigarette ignited the straw mattress after he fell asleep and the whole cabin caught fire around him"],a:0,d:2},{q:"What is unique about Victor Crowley as a slasher villain?",o:["He uses only one weapon", "He is a ghost", "He can't be killed", "He only kills at night"],a:1,d:2},{q:"What distinguishes Terror Train's kills from other slashers?",o:["The killer uses the victims' own party costumes to disguise himself and move freely among the revelers","The confined space of the train means victims cannot simply run — every direction leads to more locked cars","Kills happen almost entirely off screen with the killer's identity obscured through heavy fog and dim lanterns","The killer strikes only during the magic show performances to hide each death within the stage act's illusions"],a:0,d:2}];
const Q2c18=[{q:"What Robert Englund role appears in the original Hatchet?",o:["A swamp tour guide who dies","A backwoods police sheriff","A museum curator cameo role","A victim in the opening scene"],a:0,d:2},{q:"How does Jason kill Alice in Part 2?",o:["He stabs her with an ice pick","He drowns her in her bathtub","He uses a machete on her neck","He strangles her with a rope"],a:0,d:2},{q:"What year was Child's Play 3 released?",o:["1990", "1991", "1992", "1993"],a:1,d:2},{q:"What do the campers use to prank Cropsy in The Burning?",o:["A worm-covered decayed skull with lit candles placed right next to his sleeping body to startle him","A bucket of pig's blood rigged above his cabin door to drench him the moment that he opened it up","A dummy rigged with firecrackers and a noose placed outside his window to look like a hanging victim","A fake snake pit dug into the floor of his cabin covered with a thin canvas that collapsed underfoot"],a:0,d:2},{q:"What was Billy Loomis's motive for killing Sidney's mother?",o:["Maureen had an affair with his father which broke up his family","Maureen had killed his younger sister years before the events of Scream","He was hired to do it by her jealous husband and paid a large sum","He was copying a killing he had seen his own grandfather commit at thirteen"],a:0,d:2},{q:"What is the name of the killer in the Hatchet franchise?",o:["Victor Crowley","Harry Warden","Madman Marz","Peter Lorraine"],a:0,d:2},{q:"What does Freddy want to do through Jesse in Part 2 that differs?",o:["Possess Jesse to kill in the physical world","Rebuild his body through Jesse's dreams alone","Build a cult around Jesse's Elm Street friends","Erase Jesse's memories and become him entirely"],a:0,d:2},{q:"In My Bloody Valentine (1981), how many years before do the original murders?",o:["5 years", "10 years", "20 years", "25 years"],a:2,d:2}];
const Q2c21=[{q:"What is Eleanor's role in Jigsaw (2017)?",o:["A medical examiner who is a Jigsaw fan","A homicide detective chasing the case","A copycat killer running her own traps","A survivor from an earlier Jigsaw game"],a:0,d:2},{q:"What actress plays Sienna Shaw in Terrifier 2?",o:["Lauren LaVera", "Samantha Scaffidi", "Jenna Kanell", "Marianne Hagan"],a:0,d:2},{q:"What slasher film is set during a New Year's Eve party?",o:["New Year's Evil","Bloody New Year","Terror Tape III","The Resolution"],a:0,d:2},{q:"What is the name of the main villain in Hatchet 3?",o:["Victor Crowley", "A new character", "The sheriff", "Marybeth's father"],a:0,d:2},{q:"What is the ending of Texas Chain Saw Massacre 2?",o:["Stretch survives and raises Leatherface's chainsaw","Lefty kills Leatherface in the underground hideout","Everyone dies as the cavern explodes from gas leaks","Stretch and Leatherface flee the cave together quietly"],a:0,d:2},{q:"What is Pamela Voorhees' occupation at Camp Crystal Lake?",o:["Nurse", "Cook", "Counselor", "Owner"],a:1,d:2},{q:"What is Angela's philosophy in Sleepaway Camp 2?",o:["Kill all rule-breakers and bad campers","Kill victims in strict alphabetical order","Kill only the counselors one by one each","Kill only during full moons at midnight"],a:0,d:2},{q:"What was Johnny Depp's first film role?",o:["Nightmare on Elm Street","Platoon by Oliver Stone","Edward Scissorhands film","Private Resort teen movie"],a:0,d:2},{q:"What is the reason that Elm Street's teens cannot simply avoid sleep?",o:["They can", "Biological necessity", "There is a spell", "Freddy controls their sleeping"],a:1,d:2},{q:"What is the name of the killer in The Funhouse (1981)?",o:["The Monster", "Gunther", "The Carnival Freak", "Conrad"],a:1,d:2},{q:"What is the killer's weapon in My Bloody Valentine (1981)?",o:["A pickaxe", "A mining drill", "A shovel", "A sledgehammer"],a:0,d:2},{q:"What is the name of Jason Voorhees' father?",o:["His father is Elias per the novelization","His father is Edward in the films canon","His father is Frank from the stage play","His father is Harold per the novel series"],a:0,d:2},{q:"What is the setting of Sleepaway Camp 2?",o:["Camp Arawak again", "Camp Rolling Hills", "Camp New Horizon", "Camp Waterfront"],a:1,d:2},{q:"What did Sean Cunningham say he would never do regarding Jason after Part IV?",o:["Kill Jason permanently","Make another sequel","Recast Jason totally","Change Jason's look"],a:0,d:2},{q:"In Terror Train, what prank starts the chain of events?",o:["Kenny is locked in a room with a cadaver as a prank","Kenny is slipped a drug at the medical school party","Kenny is pushed off a balcony during a fraternity night","Kenny is tricked into kissing a woman who is really a man"],a:0,d:2},{q:"What percentage of the film is actually set in Manhattan in Part VIII?",o:["Less than a third","About three quarters","Roughly one half of it","Only about one tenth"],a:0,d:2},{q:"In Hatchet (2006), who is the killer?",o:["Victor Crowley","Ben Willis III","Harry Warden","Madman Marz"],a:0,d:2},{q:"How many survivors are there at the end of Texas Chain Saw Massacre 1974?",o:["0","1","2","3"],a:1,d:2},{q:"Who is the first victim shown in Terrifier 2016?",o:["Dawn", "Tara", "Allie", "Victoria"],a:2,d:3},{q:"What character does Courteney Cox play and what is her arc across the franchise?",o:["Sidney's friend", "Gale Weathers", "A detective", "A journalist who dies"],a:1,d:2}];
const Q2c28=[{q:"Who is Harry Warden in My Bloody Valentine?",o:["The miner who survived a cave-in by eating the other trapped miners and went insane — he became the killer","The mine owner who caused the collapse and was later murdered by families of the dead miners in the tunnels","A local police detective who investigated the original mine collapse and disappeared into the shafts one night","An old legend made up by local townspeople to scare children away from the abandoned Hanniger family coal mines"],a:0,d:2},{q:"What is the name of the killer in The Burning (1981)?",o:["Madman Marz", "Cropsy", "The Prowler", "Victor Crowley"],a:1,d:2},{q:"In Valentine (2001), what is the killer's disguise?",o:["A Cupid mask", "A heart-shaped mask", "A Valentine mask", "A cherub mask"],a:0,d:2},{q:"What is the legend of Victor Crowley?",o:["He was accidentally killed by his father on Halloween night and now haunts the Louisiana swamp","He was burned alive in his family cabin by cruel neighbors and now seeks vengeance in the Louisiana bayou","He was drowned by bullies as a child in the swamp behind his family's home and now hunts tour boat guests","He was struck by a falling tree during a bad storm and survived to roam the swamps and murder any trespassers"],a:0,d:2}];
const Q2c29=[{q:"How many kills are in Scream 6?",o:["10", "12", "14", "16"],a:1,d:4},{q:"What slasher film involves a killer at a summer theater camp?",o:["Stage Fright", "Sleepaway Camp", "The Funhouse", "Curtains"],a:0,d:2},{q:"What is the runtime of Terrifier 2?",o:["2 hours 18 minutes","2 hours 30 minutes","1 hour 52 minutes","3 hours 5 minutes"],a:0,d:2},{q:"Who plays Lieutenant 'Lefty' Enright in Texas Chain Saw Massacre 2?",o:["Dennis Hopper", "Bill Moseley", "Jim Siedow", "Edwin Neal"],a:0,d:2},{q:"What is the name of the main protagonist in Hatchet 2?",o:["Marybeth Dunston", "Marybeth Wilson", "Kelly Morse", "Lisa Crowley"],a:0,d:2},{q:"How many Jigsaw traps are shown in Saw 2004?",o:["2", "3", "4", "5"],a:1,d:3},{q:"What is the tone difference between House of 1000 Corpses and Devil's Rejects?",o:["House is a stylized horror movie homage while The Devil's Rejects is a gritty realistic road movie about outlaws","House has supernatural and occult elements throughout while The Devil's Rejects strips those out for pure realism grit","House features the Firefly siblings alone while The Devil's Rejects expands the family across several generations on screen","House was shot mostly on soundstages with heavy lighting tricks while The Devil's Rejects was filmed on location in the desert"],a:0,d:2},{q:"What slasher film is set at an ice rink?",o:["Cold Steel", "Iced", "Rink of Death", "Ice Cream Man"],a:1,d:2},{q:"What camp activity takes place the night Jason drowned?",o:["Counselors were having sex and ignoring their duties — the negligence that let Jason drown became the franchise's core moral code","Counselors were drinking illegal moonshine around the campfire and missed Jason's cries for help as he thrashed in the dark lake waters","Counselors were playing strip poker in one of the cabins during their watch and failed to notice Jason wander off to the water alone","Counselors were smoking marijuana behind the mess hall and lost track of the children in their care while Jason drifted out into the lake"],a:0,d:2},{q:"What color was the original Captain Kirk mask before it was painted?",o:["Flesh tone","Bone white","Pale gray","Dirty tan"],a:0,d:2},{q:"How many people die in Saw II?",o:["10","8","12","6"],a:0,d:3},{q:"What does the killer in The Town That Dreaded Sundown call himself?",o:["The Phantom Killer", "The Texarkana Terror", "The Moon Killer", "The Night Stalker"],a:0,d:2},{q:"What is the setting of the 2021 Wrong Turn reboot?",o:["West Virginia mountains on the Appalachian Trail","Montana wilderness along the Continental Divide path","North Carolina Smoky Mountains Blue Ridge Parkway trail","Kentucky cave country near the Mammoth Cave entrances"],a:0,d:2},{q:"What Tony Todd role appears in Hatchet?",o:["A tour boat captain","A Louisiana marsh guide","A voodoo shop owner","A swampside fisherman"],a:0,d:2},{q:"In My Bloody Valentine, who is the killer revealed to be?",o:["Tom Hanniger", "Axel Palmer", "Harry Warden", "Mabel Osborne"],a:1,d:2},{q:"What is the name of the first actress to play a Final Girl in a slasher?",o:["Janet Leigh in Psycho", "Sally Hardesty in TCM", "Marilyn Burns is often cited", "Laurie Strode in Halloween"],a:2,d:2},{q:"What is the trap in Jigsaw (2017)'s opening scene?",o:["A bucket on the head with razor blades","A circular saw suspended above victims","A series of rotating floor mounted blades","A spinning cage filled with shards of glass"],a:0,d:2},{q:"What does Art the Clown want?",o:["He has no stated motive — he kills purely for his own enjoyment","He seeks revenge against a specific Miles County family bloodline","He is under the influence of an ancient demonic Louisiana pact","He is collecting trophies to complete his murder museum basement"],a:0,d:2},{q:"What is the name of the road that leads to the Firefly house?",o:["Firefly Road", "Murder Road", "Route 666", "The Devil's Rejects Road"],a:1,d:2},{q:"How many attacks does The Phantom Killer make in The Town That Dreaded Sundown?",o:["5", "8", "10", "12"],a:1,d:2},{q:"Who plays Chop-Top in Texas Chain Saw Massacre 2?",o:["Bill Moseley", "Dennis Hopper", "Jim Siedow", "Bill Johnson"],a:0,d:2},{q:"In The Prowler (1981), what kills method does the killer use exclusively?",o:["Only a pitchfork", "Military weaponry and gardening tools", "Only a bayonet", "A pitchfork and bayonet"],a:3,d:2},{q:"What does Kenny Hampson do after his humiliation in Terror Train?",o:["He is institutionalized after a prank goes wrong and returns years later as the costumed killer on the train","He goes missing immediately after the school prank and is never seen again until the killings aboard the New Year's train","He spends years in a state prison for assaulting the pranksters and emerges to hunt them down one by one aboard the train","He takes his own life soon after the incident but his spirit returns to haunt the graduating class during their New Year's trip"],a:0,d:2},{q:"What slasher film features killings at a sorority house?",o:["The House on Sorority Row","Black Christmas (1974)","Sorority Babes in Video","Sorority Row (2009)"],a:0,d:2},{q:"In Curtains (1983), what mask does the killer wear?",o:["A hag mask", "A pig mask", "A doll mask", "A blank white mask"],a:0,d:2},{q:"How long is Cropsy hospitalized in The Burning?",o:["1 year", "3 years", "5 years", "Over 5 years"],a:2,d:2},{q:"Which actor played Jason Voorhees the most times?",o:["Richard Brooker", "C.J. Graham", "Kane Hodder", "Derek Mears"],a:2,d:2},{q:"How long was You're Next held before release after completion?",o:["6 months","Two years","One year","Three years"],a:1,d:2},{q:"Who directed Shocker?",o:["Wes Craven", "John Carpenter", "Larry Cohen", "Tobe Hooper"],a:0,d:2}];
const Q2c40=[{q:"What slasher is set during Christmas and features a mall Santa?",o:["Silent Night Deadly Night","Don't Open Till Christmas","Christmas Evil (1980)","To All A Good Night"],a:0,d:2},{q:"What is the killer's gimmick in New Year's Evil?",o:["He kills at midnight in each time zone","He only kills on the hour through the night","He calls his victims and counts down at dawn","He kills in alphabetical order of their last names"],a:0,d:2},{q:"How many people does Freddy kill in Nightmare on Elm Street 3?",o:["4", "5", "6", "7"],a:2,d:3},{q:"What is Helen Lyle's profession in Candyman?",o:["A graduate student researching urban legends","A Chicago police detective working homicide","A local journalist from the Tribune newspaper","A social worker at the Cabrini-Green housing"],a:0,d:2},{q:"Who plays Helen Lyle in Candyman?",o:["Vanessa Williams", "Virginia Madsen", "Kasi Lemmons", "Xander Berkeley"],a:1,d:2},{q:"What is the body count in Friday the 13th Part VII The New Blood?",o:["10", "12", "15", "17"],a:1,d:4},{q:"Who plays Detective Hoffman?",o:["Costas Mandylor", "Angus Macfadyen", "Tobin Bell", "Betsy Russell"],a:0,d:2},{q:"In Happy Death Day 2U, what actually causes the time loop?",o:["A quantum reactor built by Ryan causes a dimensional rift creating the loop","An ancient curse tied to the birthday of the main character causes the repeating day to happen","A rogue teaching assistant slipped the protagonist an experimental drug that caused the time loop","The original killer from the first film uses a cursed locket to trap the heroine in a repeating day"],a:0,d:3},{q:"What slasher features a killer who targets babysitters?",o:["When a Stranger Calls","Halloween John Carpenter","The Babysitter Netflix","The Sitter Film 2011"],a:0,d:1},{q:"What is Heather Langenkamp's real life situation when New Nightmare begins?",o:["She is being stalked by a real-life fan while being asked to star in a new Nightmare film — the film blurs her reality with fiction","She has retired from acting and is living a quiet suburban family life when Wes Craven personally reaches out to pitch her a bold new concept","She is making a documentary about the Nightmare on Elm Street franchise when strange things begin happening that mirror scenes from the original movies","She is writing a tell-all book about her years of working with Wes Craven on horror films when eerie parallels to the Nightmare stories start manifesting"],a:0,d:3},{q:"What makes the Hatchet franchise distinctive?",o:["The highest kill counts and most extreme practical gore effects of any modern slasher franchise to date","Victor Crowley's kills are notable for their creative brutality and complete reliance on practical makeup effects work","The franchise is shot almost entirely in a single Louisiana bayou location over all four films with the same small crew","Every film opens with a direct cameo from a classic horror icon like Robert Englund Tony Todd or Kane Hodder or Sid Haig"],a:0,d:3},{q:"How long is the confessional monologue at the end of Pearl?",o:["About 8 unbroken minutes","About 3 unbroken minutes","About 12 unbroken minutes","About 5 unbroken minutes"],a:0,d:3},{q:"In Slumber Party Massacre, who are the targets?",o:["High school girls at a sleepover","College sorority girls at a party","Camp counselors at a lake retreat","A bachelorette party in a cabin"],a:0,d:1},{q:"What is the Candyman mythology?",o:["They become his next target", "Survivors become believers", "They are protected afterward", "They lose their memory"],a:1,d:3},{q:"What is the X (2022) dual performance by Mia Goth and its technical achievement?",o:["Mia Goth plays both Maxine the young heroine and Pearl the elderly killer — using prosthetics for the older character","Mia Goth plays identical twin sisters one of whom survives the film's massacre while the other dies in the opening scene","Mia Goth plays three separate small roles throughout the film with heavy makeup making each appearance unrecognizable to fans","Mia Goth plays one single character but performs multiple age ranges through practical aging done entirely without CGI enhancements"],a:0,d:3},{q:"What is the connection between Pearl and X in Ti West's trilogy?",o:["Pearl is a prequel to X set decades earlier","Pearl is a sequel to X set immediately after","Pearl takes place in a parallel universe story","Pearl is a re-edit of footage filmed during X"],a:0,d:3},{q:"What is the infamous raft massacre scene in The Burning famous for?",o:["The number of victims killed at once with garden shears","The way it was censored and cut down by the ratings board","Being filmed in a single long take without editing cuts","Using real blood donated by the local volunteer cast"],a:0,d:2},{q:"Who directed Black Christmas 1974?",o:["John Carpenter","Wes Craven","Bob Clark","Tobe Hooper"],a:2,d:2},{q:"What actress starred in Black Christmas 1974?",o:["Jamie Lee Curtis","Olivia Hussey","Sigourney Weaver","Carrie Fisher"],a:1,d:2},{q:"What does the killer leave in victims in Maniac 1980?",o:["Scalps them and puts wigs on mannequins","Keeps severed heads frozen in his fridge","Collects their shoes and displays them neatly","Photographs each victim and prints trophies"],a:0,d:2},{q:"What city is Maniac 1980 set in?",o:["New York City","Los Angeles","San Francisco","Philadelphia"],a:0,d:2},{q:"Maniac 1980 was remade in 2012 with which actor?",o:["Elijah Wood","Michael Fassbender","Ryan Gosling","James McAvoy"],a:0,d:2},{q:"Where is Sleepaway Camp set?",o:["Camp Crystal Lake","Camp Arawak","Camp Blackwood","Camp Pinewood"],a:1,d:2},{q:"Where is Madman 1982 set?",o:["A farm","A summer camp","A cabin in the woods","A mental institution"],a:1,d:2},{q:"What weapon does the killer use in Pieces?",o:["A chainsaw","A butcher knife","A fire axe","A sickle"],a:0,d:2},{q:"What is the killer collecting in Pieces?",o:["Body parts to reassemble a human jigsaw","Severed hands to preserve in jars of oil","Human teeth to string together as a necklace","Eyes that he keeps preserved in small jars"],a:0,d:2},{q:"What is The Funhouse monster?",o:["A deformed carnival barker's son","A werewolf who stalks by moonlight","A ghost of a murdered carnival ride worker","A demon summoned by a fortune teller"],a:0,d:2},{q:"Who directed The Funhouse 1981?",o:["Wes Craven","Tobe Hooper","John Carpenter","Sean Cunningham"],a:1,d:2},{q:"What motivates the killer in Prom Night 1980?",o:["The accidental death of a child years earlier","The killer was humiliated at the prom court","A jealous romantic rivalry over a popular boy","The killer was rejected for a date to the prom"],a:0,d:2},{q:"What triggers the killing in The House on Sorority Row?",o:["A prank that accidentally kills their housemother","A rejected sorority pledge plots bloody revenge","A ghost from the house's history returns to haunt","A curse tied to the sorority's founding family line"],a:0,d:2},{q:"The House on Sorority Row was remade as what film?",o:["Sorority Row","Sorority House Massacre","Pledge Night","Rush Week"],a:0,d:2},{q:"Who directed You're Next?",o:["James Wan","Ti West","Adam Wingard","Mike Flanagan"],a:2,d:2},{q:"What is the motive behind the attacks in You're Next?",o:["A hired hit for inheritance money","A random thrill kill by masked men","Revenge for an old family business feud","A satanic ritual for the blood moon night"],a:0,d:2},{q:"What is unique about the entity in It Follows?",o:["It runs fast","It can only be seen by the person it is following","It walks slowly but never stops","It appears only at night"],a:2,d:2},{q:"Who directed It Follows?",o:["David Robert Mitchell","Jeremy Saulnier Jr","Trey Edward Shults","Jeff Nichols Davis"],a:0,d:2},{q:"What is The Strangers claim to be based on?",o:["True events and the Manson murders","A 1970s crime novel by Peter Straub","An urban legend from the Midwest US","The writer's childhood home break in"],a:0,d:2},{q:"Who directed The Strangers?",o:["Rob Zombie","Bryan Bertino","James DeMonaco","Adam Wingard"],a:1,d:2},{q:"Wolf Creek claims to be based on what?",o:["Pure fiction","True events","A novel","A documentary"],a:1,d:2},{q:"What is the controversial twist in High Tension?",o:["The final girl was the killer all along","The killer turns out to be a ghost figure","The whole film was one character's dream","The victims were already dead the whole time"],a:0,d:2},{q:"What is Victor Crowley's backstory in Hatchet?",o:["A deformed boy accidentally killed by his own father","A Vietnam veteran driven insane by combat flashbacks","An escaped mental patient stalking his childhood home","A wrongly executed man whose spirit remains as vengeance"],a:0,d:2},{q:"What is unique about the killer ChromeSkull in Laid to Rest?",o:["He films all his kills on a shoulder-mounted camera","He wears an actual human skull dipped in chrome paint","He only kills within a narrow strip of county road","He operates with a fully equipped support team crew"],a:0,d:2},{q:"Where is Hatchet set?",o:["The Everglades","The Louisiana bayou","The Florida swamps","The Mississippi delta"],a:1,d:2},{q:"What is the kill method in Happy Birthday to Me that is shown on the poster?",o:["A birthday cake with a knife","A skull with candles","A shish kebab through the mouth","A severed head on a plate"],a:2,d:2},{q:"What is a giallo film?",o:["An Italian thriller subgenre with stylized kills and mystery elements","A French horror subgenre known for its cold detached visual style","A Japanese psychological horror subgenre popular from the 1960s on","A British dark mystery film style popularized by Hammer Studios"],a:0,d:2},{q:"What Dario Argento film is considered a giallo masterpiece?",o:["Suspiria","Deep Red","Phenomena","Opera"],a:1,d:2},{q:"What does the killer in Urban Legend wear?",o:["A hockey mask","An arctic parka","A monster mask","A clown costume"],a:1,d:2},{q:"What famous horror actor cameos as a professor in Urban Legend?",o:["Robert Englund","Brad Dourif Sr","Kane Hodder III","Tony Todd Jr"],a:0,d:2},{q:"Who wrote the screenplay for I Know What You Did Last Summer?",o:["Kevin Williamson","Wes Craven Ryan","David S Goyer Jr","John Carpenter"],a:0,d:2},{q:"What is the killer's weapon in I Know What You Did Last Summer?",o:["A fishing hook","A long machete","A sharp sickle","A boat hook II"],a:0,d:2},{q:"What is the premise of Fresh 2022?",o:["A woman discovers her new boyfriend harvests and sells human meat","A family is hunted for sport by wealthy guests at a wedding retreat","A woman is stalked by her obsessive ex from across her apartment hall","Cannibalistic neighbors lure women through a dating app in a small town"],a:0,d:2},{q:"What country is Eden Lake set in?",o:["USA","Australia","England","Canada"],a:2,d:2},{q:"What makes Eden Lake particularly disturbing?",o:["The killers are teenagers with no remorse","It is supposedly based on a true British case","The victim is a small child who gets targeted","Supernatural elements enter during the final act"],a:0,d:2},{q:"What is the premise of Inside 2007?",o:["A pregnant woman is terrorized by a stranger who wants her unborn baby","A woman is trapped inside her Paris apartment during the holiday riots","A woman returns home to discover her husband has become a ruthless killer","A pregnant woman is haunted by visions of her dead mother on Christmas Eve"],a:0,d:2},{q:"My Bloody Valentine 1981 was remade in what year?",o:["2005","2007","2009","2011"],a:2,d:2},{q:"In Rob Zombie's Halloween what is Michael Myers' home life like?",o:["Extremely abusive and dysfunctional","A normal middle class suburban family","A loving single mother raises him alone","A quiet and very religious household life"],a:0,d:2},{q:"What song plays over the end credits of The Devil's Rejects?",o:["Freebird","Sweet Home Alabama","Simple Man","Ramblin Man"],a:0,d:2},{q:"What is the rule in Final Destination about cheating death?",o:["Death comes back for those who cheated it in order","Death gives them exactly one extra day to live","Death can be beaten if the design is destroyed","Death sends a warning vision before each victim"],a:0,d:2},{q:"What is the significance of the year 1978 in slasher history?",o:["Halloween was released changing horror forever","Friday the 13th was released ahead of schedule","The first recognized final girl appeared on screen","The first slasher film was released theatrically"],a:0,d:2},{q:"What streaming service is Mike Flanagan most associated with?",o:["Hulu","Amazon Prime","Netflix","Peacock"],a:2,d:2},{q:"What is the premise of Hush by Mike Flanagan?",o:["A deaf woman is stalked in her isolated home","A blind writer survives a killer in the woods","A mute librarian fights back on a snowy night","A trapped woman is stalked through her car's GPS"],a:0,d:2},{q:"What is the year Black Christmas 1974 was released and why does it matter?",o:["1974 predates Halloween by four years","1976 was the first ever POV slasher film","1972 holds first slasher release credit","1975 was the first female killer debut"],a:0,d:2},{q:"Who directed High Tension 2003?",o:["Pascal Laugier","Alexandre Aja","Xavier Gens","Robin Hardy"],a:1,d:2},{q:"What is the Madman Marz legend?",o:["A farmer who killed his family and returns when his name is called","A Vietnam veteran who lost his mind and stalks the Catskills mountains","A wrongly executed convict who haunts the camp where he was captured","A drowned boy whose spirit rises when teenagers light the summer campfire"],a:0,d:2}];
const Q3c2=[{q:"In what country was Ti West's Pearl (2022) filmed?",o:["United States","New Zealand","Australia","Canada"],a:1,d:1},{q:"How many people does Jason kill in Jason X?",o:["16", "20", "23", "25"],a:2,d:4},{q:"In Saw what is Jigsaw's rule about his traps?",o:["Every trap has an escape if the person fights hard enough","Only those who truly want to live will ever escape his traps","The traps are always built to kill unless Jigsaw chooses mercy","Victims must confess their crimes aloud before the trap will release"],a:0,d:3},{q:"Who created the Chucky TV series?",o:["Tom Holland", "Don Mancini", "Brad Dourif", "Lars Klevberg"],a:1,d:3},{q:"Who dies last in the original Friday the 13th before Alice?",o:["Jack", "Marcie", "Steve Christy", "Bill"],a:3,d:4},{q:"In Saw III, what is revealed about Amanda Young's traps?",o:["Her traps were deliberately made inescapable — she wanted no survivors","Her traps were tested extensively on live subjects before any victims saw them","Her traps were designed with Jigsaw's direct input but flawed in specific ways","Her traps were always easier than Jigsaw's because she felt pity for the victims"],a:0,d:3},{q:"What is the Camp Crystal Lake mythology about what happened the year Jason?",o:["Random accident", "The counselors were having sex and not watching the children — Jason drowned while they were distracted", "Just an accident", "A storm distracted them"],a:0,d:3},{q:"What is the phrase that activates Candyman in the 2021 film?",o:["Say his name", "Call his name", "Candyman five times", "Say 'Candyman'"],a:3,d:3},{q:"What is Tree's real name in Happy Death Day?",o:["Theresa","Tabitha","Tiffany","Therese"],a:0,d:2},{q:"Who directed You're Next (2011)?",o:["Ti West", "Adam Wingard", "Simon Barrett", "Joe Swanberg"],a:1,d:3},{q:"What Chicago housing project is central to the Candyman mythology?",o:["Robert Taylor Homes","Cabrini-Green","Stateway Gardens","The Ida B. Wells Homes"],a:1,d:2},{q:"What real Hollywood events does MaXXXine reference?",o:["The Night Stalker murders of the 1980s","The Hillside Strangler murders in 1977","The Manson Family murders from 1969","The Zodiac Killer cases in San Francisco"],a:0,d:3},{q:"What innovation did My Bloody Valentine 3D (2009) bring to the slasher genre?",o:["It was the first major slasher to use digital 3D projection","It invented a new handheld rig for shooting in stereoscopic mode","It was the first horror film produced with 48fps high frame rate","It was the first slasher remake to outgross its original at the box office"],a:0,d:3},{q:"What is the total kill count across all five original Nightmare on Elm Street films?",o:["Around 20","Around 30","Around 40","Around 50"],a:1,d:4},{q:"What is the killer's mask in The Town That Dreaded Sundown (1976)?",o:["A white mask", "A burlap sack", "A pig mask", "A gas mask"],a:1,d:3},{q:"What is the Saw franchise continuity achievement that is its most praised?",o:["The interconnected timeline","The creative gore effects sequences","The consistent quality of acting cast","The distinct directorial style of each"],a:0,d:3},{q:"What is the Chucky TV series' specific advantage over the films?",o:["The long-form format allows genuine character","It features far more creative kills per episode","It offers much broader comedic tonal range use","It has better practical puppet effects throughout"],a:0,d:3},{q:"What is Damien Leone's stated goal with Art the Clown as an icon?",o:["A one-time character", "He wants Art to join the ranks of Freddy, Jason and Michael as an iconic horror villain with his own franchise", "Shock value only", "A franchise for its own sake"],a:0,d:3},{q:"What is the killer's motivation in The House on Sorority Row?",o:["Revenge for a dead child", "Jealousy", "Insanity from a botched experiment", "A supernatural curse"],a:0,d:3},{q:"What is Maxine's goal in MaXXXine?",o:["To become a Hollywood actress","To escape Pearl's tragic fate","To avenge X's dead victims","To find her real birth father"],a:0,d:3}];
const Q3c9=[{q:"In Happy Death Day 2U, what parallel universe discovery does Tree make?",o:["Her mother is alive in the alternate timeline","The killer is revealed to have been her brother","The entire campus was destroyed in the other reality","Carter her boyfriend was never born in that timeline"],a:0,d:3},{q:"What Ti West says about the X trilogy being connected?",o:["The three films form a career-spanning portrait of Pearl — from her origins in 1918 to her final act of violence","The three films are entirely standalone stories with only a loose shared setting — Ti West has said each can be watched alone","The three films share a visual aesthetic and period setting but have no narrative connection — they are thematic companion pieces","The three films were all written at the same time as a single 900-page screenplay — Ti West split it into parts during production phase"],a:0,d:3}];
const Q3c10=[{q:"What is the Victor Crowley origin myth's tragic irony that distinguishes it?",o:["Pure malice origin", "The accident", "Supernatural cause", "Bullying cause"],a:1,d:3},{q:"What is the specific Mia Goth performance achievement in Pearl?",o:["Standard horror acting", "The final close-up", "The killing scenes", "The dance sequence"],a:1,d:3},{q:"What is the specific The Strangers (2008) technique for showing the killers?",o:["They appear in background shots behind the main","They are shown clearly only once in the entire film","They wear different masks throughout the entire film","They appear only in reflected surfaces like windows"],a:0,d:3},{q:"What is the Happy Death Day production achievement given its Blumhouse budget?",o:["The time loop mechanic allowed a tiny budget","They used a single massive Louisiana sound stage","Blumhouse provided a large but hidden budget line","They shot the whole film using only three real sets"],a:0,d:3}];
const Q3c11=[{q:"What is the Slumber Party Massacre II and III's relationship to the original?",o:["Direct sequels with same characters","Thematic connection only really","Unrelated films using the title","Same cast but very new story"],a:0,d:3},{q:"What is the connection between Tree's birthday and her mother in Happy Death?",o:["Her mother died on her birthday", "Her mother was also named Tree", "They share a birthday and her mother's death makes", "No connection"],a:0,d:3},{q:"What does Dylan keep chanting in New Nightmare?",o:["Now I lay me down to sleep prayer","The original Freddy Krueger rhyme","The Elm Street address over again","Heather's full name over and over"],a:0,d:3}];
const Q3c12=[{q:"What is the Rob Bottin practical effects achievement in The Thing that Rob?",o:["Bottin has described The Thing as the most","Bottin was replaced mid-production by his team","Bottin delivered standard creature effects work","Bottin later said the job was mostly routine"],a:0,d:3},{q:"What is the specific film Wrong Turn most directly references in its premise?",o:["The Hills Have Eyes (1977) by Wes Craven","The Texas Chain Saw Massacre Hooper","Halloween 1978 by John Carpenter","Deliverance 1972 by John Boorman"],a:0,d:3},{q:"In The Burning (1981), what is the name of the summer camp?",o:["Camp Crystal Lake","Camp Arawak","Camp Blackfoot","Camp Stonewater"],a:2,d:3},{q:"What is the Evil Dead 2 tonal shift from the original that confused audiences?",o:["A significant shift toward dark comedy and slapstick","A drastic increase in graphic gore over the first film","A sudden lean into supernatural religious horror themes","A move away from practical effects to early CGI sequences"],a:0,d:3},{q:"What is the Terrifier 3 production announcement?",o:["No announcement", "Terrifier 3 was announced with a budget", "Small budget again", "A streaming release only"],a:0,d:3},{q:"What is The Black Phone's specific period detail that enhances its horror?",o:["Its 1978 setting predates child safety culture","The 1986 setting captures Satanic Panic fully","The 1973 setting matches the book's era well","The 1999 setting allowed early cell phones use"],a:0,d:3},{q:"What slasher from 2011 uses social media as a key component?",o:["Unfriended", "Scream 4", "Smiley", "Cyberbully"],a:1,d:3},{q:"How does Happy Death Day function as slasher commentary?",o:["The time loop literalizes the slasher formula — the heroine must die repeatedly to survive her ordeal","The protagonist's gradual moral growth each loop mirrors the genre's arc toward empowered final girl heroines","The killer's identity switches each cycle reflecting how slasher franchises swap antagonists across each sequel","The film comments on how slasher victims are disposable by literally letting its heroine die over and over again"],a:0,d:3},{q:"What is Curse of Chucky's specific return to tone after Seed's campy humor?",o:["A deliberate return to the original film's horror tone","A continued lean into self-aware campy horror comedy style","A total reinvention as a gothic supernatural haunted story","A pivot to found footage style horror with a handheld camera"],a:0,d:3},{q:"What is Anthony McCoy's connection to the original Candyman?",o:["He is Helen's son", "He is Daniel Robitaille's descendant", "He is a researcher", "He is new with no connection"],a:0,d:3},{q:"What is the Candyman 1992 location choice and its cultural significance?",o:["Random Chicago location", "Cabrini-Green", "A generic inner city location", "A fictional location"],a:0,d:3},{q:"In Sorority Row (2009), what is the killer's weapon?",o:["A modified tire iron with a blade","A sawed-off shotgun with nails","A shortened spear with fishhooks","A hunting knife with a long blade"],a:0,d:3},{q:"When did Donald Pleasence die?",o:["1993", "1994", "1995", "1996"],a:2,d:3},{q:"What does Don Mancini think of the 2019 Child's Play reboot?",o:["He was not involved and has publicly disapproved of it — he continued his own Chucky continuity separately afterward in the TV show","He was a credited executive producer on the reboot film and worked closely with the new director to update the Good Guys doll character","He wrote a draft of the reboot's screenplay that was heavily rewritten before production began and he distanced himself from the final cut","He pitched his own reboot concept that was rejected by the studio in favor of the version that ended up being released in theaters in 2019"],a:0,d:3},{q:"Where is Candyman 3: Day of the Dead (1999) set?",o:["Chicago","Los Angeles","New Orleans","Cabrini-Green"],a:1,d:3},{q:"What is the Platinum Dunes production company role in 2000s slasher remakes?",o:["Platinum Dunes produced the major 2000s remakes of Texas Chainsaw, Friday the 13th and A Nightmare on Elm Street","Platinum Dunes was the small distribution label for a series of direct-to-video slasher sequels during the mid to late 2000s","Platinum Dunes functioned as an art house label that brought European horror remakes to American theaters through limited releases only","Platinum Dunes operated primarily as a post-production effects house that polished several slasher remakes but did not produce any of them"],a:0,d:3},{q:"What character from X reappears in MaXXXine?",o:["Pearl","Bobby-Lynne","Jackson Hole","The Porn Director"],a:0,d:3},{q:"What is the name of the final girl in Freddy vs. Jason?",o:["Destiny Miller","Lori Campbell","Monica Carson","Jenny"],a:1,d:3},{q:"What TV series continues the original Child's Play franchise?",o:["Chucky", "Good Guy", "Doll Kill", "Child's Play: The Series"],a:0,d:3},{q:"What is the name of Ash's car in the Evil Dead films?",o:["A Delta 88", "A 1973 Oldsmobile Delta 88", "A 1967 Chevy Impala", "A Ford pickup"],a:0,d:3}];
const Q3c21=[{q:"According to Jason Goes to Hell, what is the only way to truly kill Jason?",o:["Only a Voorhees can kill Jason and only with a special dagger — establishing a supernatural mythology for the franchise","Only fire can destroy the body permanently and only if it is done at Camp Crystal Lake itself during the summer solstice season","Only a child killed by Jason can defeat him by reciting the names of every previous victim in the correct order of their deaths","Only drowning in the same lake Jason drowned in will end him and only if his mother's severed head is tied around his neck first"],a:0,d:3},{q:"Who directed Freddy's Dead: The Final Nightmare?",o:["Renny Harlin", "Rachel Talalay", "Tom McLoughlin", "Chuck Russell"],a:1,d:3},{q:"What is MaXXXine's genre compared to the other X films?",o:["An 80s slasher set in Hollywood with a serial","A pure remake of X with new cast members only","A ghost story set on the original Texas X farm","A character-driven drama with no genre elements"],a:0,d:3},{q:"What is Rob Dier's connection to the previous films?",o:["His sister was Sandra from Part II","He is Jason Voorhees' older cousin","He is Alice Hardy's biological brother","He is a journalist investigating kills"],a:0,d:3},{q:"In You're Next, what animal masks do the killers wear?",o:["Fox, Rabbit, Tiger", "Lamb, Wolf, Fox", "Lamb, Tiger, Fox", "Fox, Tiger, Rabbit"],a:0,d:3},{q:"What is the narrative role of the 'false scare' in slasher films?",o:["A fake threat that resets the audience's tension","A cheap trick used only to pad out the film's length","A subplot introduction device that builds up backstory","An always redundant beat that directors cut on rewatch"],a:0,d:3},{q:"What is the Texas Chain Saw Massacre formal quality?",o:["The violence is extremely graphic","The implied off-screen violence","The film has no onscreen gore","The fast editing pace creates it"],a:0,d:3},{q:"In Terrifier 2, what new character is introduced?",o:["The Pale Girl", "The Harvester", "The Dark Clown", "The Mirror Woman"],a:0,d:3},{q:"What is different about Freddy's appearance in New Nightmare?",o:["He has a new more terrifying look with longer claws","He appears in a suit instead of his classic sweater","He is shown without his iconic brown fedora hat on","He looks exactly the same as the previous film appearances"],a:0,d:3},{q:"What is the musical score choice in Candyman 1992 that elevates the film?",o:["Philip Glass composed the haunting minimalist score","John Carpenter composed a throbbing synthesizer score","Ennio Morricone composed a lush orchestral suite score","The film uses a completely license-free stock music score"],a:0,d:3},{q:"What is the specific Candyman mythology about how a legend survives?",o:["Fear keeps it alive", "The act of saying his name five times in a mirror summons him — disbelief followed by belief is what gives the legend power", "Blood sacrifices", "Ritual repetition"],a:0,d:3},{q:"What is the most acclaimed slasher of the 2020s by critical consensus?",o:["X", "Pearl", "Scream (2022)", "Terrifier 2"],a:0,d:3},{q:"Who wins at the end of Freddy vs. Jason?",o:["Freddy", "Jason", "Neither", "Lori Campbell"],a:1,d:3},{q:"What is the Philip Glass score's effect on the Candyman's mythology?",o:["It sounds scary", "The sacred choral quality elevates Daniel", "It sounds sad", "It sounds threatening"],a:0,d:3},{q:"What is the Texas Chain Saw Massacre ending quality?",o:["Leatherface dies", "Sally's hysterical laughter in the escaping truck", "She kills Leatherface", "She escapes cleanly"],a:0,d:3},{q:"What is the specific Ma (2019) connection to Mean Girls and high school horror?",o:["Ma is essentially a high school revenge film","Ma is a direct parody of the Mean Girls film","Ma shares cast members with the Mean Girls cast","Ma's director had also worked on the Mean Girls"],a:0,d:3},{q:"What is the Texas Chainsaw Massacre 2003 remake's relationship to the original?",o:["A faithful remake", "The remake changes the story significantly", "An identical remake", "A sequel not a remake"],a:0,d:3},{q:"What social issue does Candyman 2021 explore?",o:["Gentrification and police brutality in Chicago","Immigration enforcement and border security today","Economic inequality in the American South region","Drug addiction and rural opioid crises in Detroit"],a:0,d:3},{q:"Who co-wrote Pearl with Ti West?",o:["Mia Goth co-wrote it with him","Brandon Cronenberg wrote it","Jade Halley Bartlett wrote it","A24 story team co-wrote it"],a:0,d:3},{q:"What does the final reveal in Bodies Bodies Bodies suggest about the characters?",o:["Their inability to simply talk to each other caused every death — the killer was never real, it was just a string of accidents","Their secret childhood pact to eliminate one another returned to haunt them on the exact anniversary of their original blood oath being made","Their wealthy parents had hired the killer as a reality show experiment — the whole night was staged entertainment for a paying elite audience","Their shared addiction to social media finally manifested as a literal murderous app that had been secretly collecting their data for years on end"],a:0,d:3},{q:"What is the Candyman racial commentary about Cabrini-Green?",o:["The film explicitly engages with how urban legends","The commentary is limited to brief background details","The commentary exists only in the DVD bonus features","The commentary was cut from the final theatrical release"],a:0,d:3}];
const Q3c28=[{q:"What is the specific My Bloody Valentine (1981) achievement in slasher history?",o:["It is the purest expression of the holiday slasher","It had the highest body count of any 80s slasher","It was the very first holiday themed slasher film","It invented the miner killer subgenre of slasher"],a:0,d:3},{q:"What slasher film is set at a drive-in theater?",o:["Drive In Massacre", "Drive-In Killer", "Carnage at the Drive-In", "Terror at the Drive-In"],a:0,d:3},{q:"What real event does Bryan Bertino cite as inspiration for The Strangers?",o:["A childhood memory of strangers coming to the door","The infamous Tate-LaBianca murders committed in 1969","A string of home invasion murders in the 1970s era","A dream the director had while shooting a short film"],a:0,d:3},{q:"What twist in Curse of Chucky connects it back to the original Child's Play?",o:["Nica Pierce is revealed to be the daughter of a woman Charles Lee Ray murdered before possessing the Good Guy doll in the original film","Andy Barclay appears in a mid-credits scene holding his original Chucky doll and preparing to confront the newly resurrected killer one more time","Karen Barclay is revealed to have survived the events of Child's Play 2 and is now living in the same house where Curse of Chucky takes place","The house in Curse of Chucky is shown to be the same one where Charles Lee Ray was shot at the start of Child's Play using the exact same address"],a:0,d:3},{q:"What is the specific production achievement of Pearl (2022) in maintaining its 1918 period setting?",o:["It was shot back-to-back with X in New Zealand using the same location","It was shot entirely on a single soundstage in Los Angeles with matte paintings backing","It was filmed over three separate trips to Texas to capture different seasons authentically","It was a fully virtual production shot on a massive LED video wall for all exterior scenes"],a:0,d:3},{q:"What is the specific Adam Wingard technique in You're Next that builds dread?",o:["Protracted stalking sequences in bright daylight","Extremely dark cinematography in every single scene","Shakycam handheld found footage segments used","Non-diegetic scored stings timed to every kill"],a:0,d:3},{q:"What was the budget of X (2022) by Ti West?",o:["Under a million", "Around $1 million", "Around $5 million", "Around $10 million"],a:0,d:3},{q:"What is the Wrong Turn franchise villain design evolution from 2003 to 2021?",o:["Same design throughout", "The original three deformed cannibals were designed", "Minor changes", "CGI replacement"],a:0,d:3}];
const Q3c30=[{q:"What is the Hatchet production choice about its R rating and the subsequent?",o:["Released rated R only", "Adam Green initially released Hatchet unrated to preserve the extreme gore, then released an R-rated version for wider distribution", "Only unrated", "Only rated R"],a:0,d:3},{q:"What is the Kevin Bacon cameo in MaXXXine and its significance?",o:["Kevin Bacon plays a sleazy private investigator","Kevin Bacon plays the chief of Los Angeles police","Kevin Bacon plays a washed up Hollywood producer","Kevin Bacon plays himself attending a red carpet"],a:0,d:3}];
const Q3c31=[{q:"What is the specific Jason Goes to Hell creature mythology?",o:["Jason is revealed to be a demonic body-jumping entity that can possess other people — a controversial departure from series canon","Jason is revealed to be a cursed zombie reanimated by an ancient blood pact made by his mother before he was born in the film's prologue","Jason is revealed to be a clone created by a shadowy military experiment program that was conducted near Camp Crystal Lake in the 1950s","Jason is revealed to be a ghost whose physical form is held together only by pure will until the sacred Voorhees dagger finally destroys him"],a:0,d:3},{q:"What is the name of the location in Friday Part VI?",o:["Crystal Lake renamed Forest Green by residents","Camp Crystal Lake as always in the franchise","A new Camp Forest Green run by Paul's family","Lake Minnetonka in Minnesota during summer time"],a:0,d:3}];
const Q3c32=[{q:"What does Terrifier 2's success prove about the horror marketplace?",o:["Extreme horror is mainstream", "An unrated no-budget extreme horror film can", "Studio films are dying", "Gore sells"],a:0,d:3},{q:"Bob Clark directed both Black Christmas and what holiday film?",o:["National Lampoon's Christmas Vacation", "A Christmas Story", "Home Alone", "It's a Wonderful Life"],a:1,d:3},{q:"What is the specific communication motif in The Black Phone?",o:["Just a phone call", "The dead children", "A supernatural device", "A dream device"],a:0,d:3},{q:"In Intruder (1989), where do the killings take place?",o:["A grocery store","A small warehouse","A highway motel","A family hotel"],a:0,d:3},{q:"What is the Dream Demon sequence in Freddy's Dead?",o:["Freddy receives his powers from dream demons","A sequence where the final battle takes place","A nightmare that resets Nancy's whole story","A Freddy origin flashback to his human life"],a:0,d:3},{q:"What FX artist made his feature debut with The Burning?",o:["Rick Baker", "Tom Savini", "Dick Smith", "Rob Bottin"],a:1,d:3},{q:"How was Jason resurrected for Part VI after the Roy Burns detour?",o:["Tommy Jarvis accidentally resurrects him with lightning","A local coven of witches deliberately resurrects him at night","A mysterious government agent revives him to use as a weapon","He simply was never dead and had been hiding in the lake bottom"],a:0,d:3},{q:"What Candyman sequel is set specifically during Mardi Gras?",o:["Candyman: Farewell to the Flesh","Candyman 3: Day of the Dead film","Candyman (2021) Nia DaCosta film","Candyman: Carnival of Souls part"],a:0,d:3},{q:"What is the Jessica Biel performance?",o:["Standard horror acting", "Biel's physical performance", "Unnotable performance", "She was miscast"],a:0,d:3},{q:"Who directed A Bay of Blood?",o:["Dario Argento", "Lucio Fulci", "Mario Bava", "Umberto Lenzi"],a:2,d:3},{q:"What is the twist ending of Bodies Bodies Bodies?",o:["David accidentally killed himself with his own sword — there was no murderer","The entire weekend was staged by a reality TV producer hidden within the group","The killer turned out to be the estranged twin sister of the host of the party","The group's drug dealer poisoned them all in revenge for a prior failed deal run"],a:0,d:3},{q:"In Slaughter High (1986), what is the killer's name?",o:["Marty Rantzen", "Carl Pendleton", "Billy Crane", "Simon Cromwell"],a:0,d:3},{q:"In X 2022 what does the elderly farm owner Howard secretly do?",o:["Watches the film crew through windows","Drugs their shared breakfast food stash","Calls the local sheriff about the crew","Hides their van keys inside the barn"],a:0,d:3},{q:"What specific Psycho element most directly influenced the slasher genre?",o:["The transformation of an ordinary motel into a place of horror — proving familiar safe spaces could become sites of extreme terror","The use of a silent masked killer who stalks victims slowly — establishing the signature visual language of the modern slasher film genre","The structure of killing off the apparent protagonist in the first act — pioneering the now-standard slasher rug-pull opening kill trick","The introduction of graphic onscreen violence in mainstream cinema — breaking the Hays Code restrictions that had governed horror up to that point"],a:0,d:3},{q:"What is significant about the Candyman's social geography in Candyman (1992)?",o:["The horror is specifically located in the Cabrini-Green housing project — the killer emerges from Black urban trauma and the neglect of impoverished communities by city authorities","The horror is rooted in the forested North Shore suburbs where Helen Lyle does her academic research — the contrast between privilege and urban legend is the film's core critique","The horror is centered around a luxury high-rise that overlooks the housing project — the film critiques how the wealthy observe and fetishize the suffering of the people below them","The horror is distributed across multiple Chicago neighborhoods that Helen visits during her research — the film portrays the city itself as a character that consumes its own residents one by one"],a:0,d:3},{q:"What is the specific Hatchet gore philosophy Adam Green has articulated?",o:["Anything goes", "The kills should be fun rather than disturbing", "Realistic gore only", "Psychological horror is better"],a:0,d:3},{q:"What is the specific The Burning raft massacre's technical achievement?",o:["Multiple victims killed in a single continuous","It was the first slasher night kill on water","It was the first group kill using one weapon","It was the very first night kill in the genre"],a:0,d:3},{q:"Who directed Black Christmas (1974)?",o:["Bob Clark", "Tobe Hooper", "Wes Craven", "John Carpenter"],a:0,d:3},{q:"What is Pearl's confession scene at the end of Pearl (2022)?",o:["She delivers an unbroken single shot monologue","She writes a long letter to her absent husband","She confesses aloud to the mirror in her bedroom","She tells her mother in a tearful bedside scene"],a:0,d:3},{q:"What setting makes Midsommar unique among horror films?",o:["It takes place entirely in daylight","It happens deep underground the earth","It unfolds during an endless dark winter","It is set completely underwater in a lake"],a:0,d:3},{q:"In Happy Death Day 2U, what causes Tree to relive her day?",o:["A quantum physics experiment","An ancient cursed family ring","A ritual performed in a dorm","A birthday wish whispered aloud"],a:0,d:3},{q:"What event from the past triggers the killings in Prom Night (1980)?",o:["The accidental death of a child six years earlier","A devastating school fire four years earlier","The murder of a teacher eight years earlier","A hazing incident from the previous year now"],a:0,d:3},{q:"In The Collector (2009), what does the Collector do to his victims?",o:["He collects one survivor while killing the rest","He keeps them in coffin-like crates in his van","He tortures them briefly then releases them all","He mails pieces of them to the victim's family"],a:0,d:3},{q:"What difficult choice does Tree face at the end of Happy Death Day 2U?",o:["She must choose between returning home or staying in the alternate timeline where her mother is alive again","She must choose between killing the Babyface killer or letting him escape to preserve the time loop fabric","She must choose between saving Carter or saving her best friend Lori when both are attacked at the exact same moment","She must choose between accepting her own death permanently or passing the time loop curse on to someone else in her dorm"],a:0,d:3},{q:"What slasher film is set at a ski resort and features a killer in a ski mask?",o:["Iced (1988)", "Shredder", "Cold Terror", "Freeze Frame"],a:0,d:3}];
const Q3c38=[{q:"In Pearl 2022 what country does Pearl live in?",o:["America","Germany","France","Australia"],a:0,d:2},{q:"What is the central motif of Slaughter High?",o:["An April Fools reunion at the school","A Halloween party reunion at the home","A graduation ceremony gone bad once","A decade reunion held at a prom dance"],a:0,d:3},{q:"In Jason Goes to Hell, how is Jason destroyed?",o:["He is dragged to hell by demons","He is melted in a chemical fire","He is pulled into the lake's bottom","He is blown up with a large bomb"],a:0,d:3},{q:"What genre does Happy Death Day 2U blend with slasher?",o:["Science fiction","Romantic comedy","Sports action","Period drama"],a:0,d:3}];
const Q3c39=[{q:"What is the Scream innovation?",o:["The specific conversation before violence","The first ever voice changer device used","The first slasher to make phone calls scary","The use of modern technology as horror tool"],a:0,d:3},{q:"Who composed the score for The Burning?",o:["John Carpenter","Harry Manfredini","Rick Wakeman","Goblin"],a:2,d:3},{q:"What technique does Black Christmas use that Halloween later made famous?",o:["The killer's POV shot","The Final Girl trope","The early jump scare","The false ending trick"],a:0,d:3},{q:"What holiday sequel did Black Christmas director Bob Clark make?",o:["Silent Night Deadly Night","Christmas Evil","A Christmas Story","Black Christmas 2"],a:2,d:3},{q:"Who directed Maniac 1980?",o:["William Lustig","Abel Ferrara","Larry Cohen","Frank Henenlotter"],a:0,d:3},{q:"Who did the special effects for The Prowler?",o:["Rick Baker","Rob Bottin","Tom Savini","Stan Winston"],a:2,d:3},{q:"What weapon is the killer associated with in The Prowler?",o:["A knife","A pitchfork","A shotgun","A bayonet"],a:3,d:3},{q:"What makes Sleepaway Camp stand out in 1980s slasher history?",o:["Its LGBTQ themes and shocking twist","Its highest ever slasher body count","Its use of a female killer reveal","Its introduction of camp slashers"],a:0,d:3},{q:"Who is the master of giallo cinema?",o:["Lucio Fulci","Mario Bava","Dario Argento","Ruggero Deodato"],a:2,d:3},{q:"What color-based title is a famous Dario Argento giallo?",o:["Red Deep","Deep Red","Blood Red","Crimson"],a:1,d:3},{q:"What Italian director made Bay of Blood which influenced Friday the 13th?",o:["Dario Argento","Lucio Fulci","Mario Bava","Umberto Lenzi"],a:2,d:3},{q:"What is the most famous shot style in giallo films?",o:["Extreme close-ups of eyes and gloved hands during kills","Wide tracking shots that follow victims through hallways","Fast whip pans that cut between victim faces and killers","Slow motion shots of blood droplets hitting tiled floors"],a:0,d:3},{q:"Who directed Stage Fright 1987?",o:["Dario Argento","Michele Soavi","Lucio Fulci","Mario Bava"],a:1,d:3},{q:"What is the motive in Happy Birthday to Me?",o:["Revenge against the top social group at a school","A jealous boyfriend's plot against his cheating ex","A satanic ritual requiring seven victims of choice","Random killings driven by unexplained inner madness"],a:0,d:3},{q:"What is the central twist of Blood Rage?",o:["A twin committed the murders but blamed his brother","The local cop was the killer hiding in plain sight","The entire killing spree was one character's dream","The killer had been dead all along and was a ghost"],a:0,d:3},{q:"How do you summon Madman Marz?",o:["Say his name above a whisper","Knock on his cabin wall thrice","Stare at a mirror and call out","Burn a picture of his home barn"],a:0,d:3},{q:"What is the Slaughter High killer's name?",o:["Marty","Billy","Tommy","Roy"],a:0,d:3},{q:"What decade does It Follows appear set in despite being made in 2014?",o:["Deliberately ambiguous","Clearly set in the 1970s","Clearly set in the 1980s","Clearly set in the 1990s"],a:0,d:3},{q:"What is notable about the score of It Follows?",o:["It has a synth score reminiscent of 1980s horror","It was scored entirely by composer John Carpenter","It uses classical string arrangements from Vivaldi","It uses no scored music at all throughout the film"],a:0,d:3},{q:"What does the term giallo mean in Italian?",o:["Yellow — from yellow covers of crime paperbacks","Blood — the Italian word for blood in a sense","Horror — old usage in Sicilian theatre traditions","Death — from a 1920s pulp fiction marketing term"],a:0,d:3},{q:"What caused the slasher boom of the early 1980s?",o:["The success of Halloween and Friday the 13th combined with low production costs","The sudden lifting of MPAA restrictions on graphic onscreen violence during the era","The emergence of new special effects technology making realistic gore newly affordable","The cultural aftermath of the Psycho 1960 theatrical release sparking copycat filmmaking"],a:0,d:3},{q:"What is the significance of the holiday setting in slasher films?",o:["Holidays create social pressure isolation and a framework for revenge","Holidays provide a natural way to market sequels across consecutive years","Holidays allow the killings to all be contained within a single short day","Holidays draw larger audiences who want seasonal themed horror experiences"],a:0,d:3},{q:"What does POV shooting achieve in slasher films?",o:["Places the viewer in the position of the killer creating complicity","Saves significant production money through clever single camera setups","Forces editing shortcuts that allow the director to hide poor effects","Makes every stalking scene look more realistic by avoiding showing faces"],a:0,d:3},{q:"What is the difference between a slasher and a splatter film?",o:["Splatter focuses on graphic gore while slasher focuses on the hunt","Splatter films never feature a masked killer character whatsoever","Splatter films are always short films and slashers are feature length","Splatter avoids the Final Girl trope entirely and kills everyone onscreen"],a:0,d:3},{q:"Who directed Hatchet series?",o:["Adam Green","James Wan","Greg McLean","Rob Zombie"],a:0,d:3},{q:"What cameo appears in Graduation Day?",o:["Ronald Reagan","Vanna White","A young Tom Hanks","David Prowse"],a:1,d:3},{q:"Who directed Martyrs 2008?",o:["Alexandre Aja","Pascal Laugier","Xavier Gens","Julien Maury"],a:1,d:3},{q:"What is the famous line the killer says in Wolf Creek?",o:["You are not going anywhere","Head on a stick","No one can hear you","You will never leave here"],a:1,d:3},{q:"Who directed Wolf Creek?",o:["James Wan","Greg McLean","John Jarratt","David Michod"],a:1,d:3},{q:"What French horror film explores suffering and transcendence?",o:["High Tension","Inside","Martyrs","Raw"],a:2,d:3},{q:"What actor plays Otis in Rob Zombie's House of 1000 Corpses?",o:["Sid Haig","Bill Moseley","Ken Foree","Michael Berryman"],a:1,d:3},{q:"What year did the slasher boom peak?",o:["1978","1980","1981","1983"],a:2,d:3},{q:"What is the significance of the mask in slasher iconography?",o:["It dehumanizes the killer creating a symbolic force rather than a person","It protects the stunt performer playing the killer from injury on set","It allows the killer's identity to be a mystery until the third act reveal","It makes merchandising and Halloween costume sales easier for studios afterward"],a:0,d:3},{q:"What filmmaker is considered the father of the slasher film?",o:["Alfred Hitchcock","John Carpenter II","Mario Bava Sr.","William Castle"],a:0,d:3},{q:"Who plays the villain in Tourist Trap?",o:["Vincent Price","Chuck Connors","Robert Englund","Donald Pleasence"],a:1,d:3},{q:"What is the significance of summer camps in slasher films?",o:["They represent loss of innocence and isolated spaces where authority is absent","They are cheap filming locations that reduce production costs for indie films","They are popular real-life destinations with teens making them relatable targets","They are visually striking because of the natural lighting and lakeside cinematography"],a:0,d:3}];
const Q4c0=[{q:"What makes April Fool's Day (1986) unique in the slasher genre?",o:["It subverts the genre with no actual murders — it's all a prank","It was the first slasher film to be directed entirely by a woman","It holds the record for the highest female-to-male kill ratio ever","It features the highest on-screen body count of any slasher made"],a:0,d:1},{q:"In Happy Birthday to Me, what is unusual about the killer's methods?",o:["They use elaborate unusual methods tied to the birthday theme","They only ever use a single straight-edge knife throughout film","They never use any weapons and only rely on clever rigged traps","They use a modified chainsaw with a distinctive hand-carved handle"],a:0,d:1},{q:"What is unusual about the production history of You're Next (2011)?",o:["The film was held for two years after completion before release","The entire movie was shot over just three days in a rural farmhouse","The production was kept completely secret and done without permits","The project was originally conceived and shot as a TV pilot movie"],a:0,d:1},{q:"What is the name of the hotel in The Shining?",o:["The Torrance Inn","The Overlook Hotel","The Stanley Hotel","The Redrum Lodge"],a:1,d:1},{q:"What did Giallo films contribute to the slasher genre?",o:["Stylized kill sequences and black-gloved killers","The masked killer figure that defined the 1980s","The Final Girl trope and its survivor archetype","Nothing significantly transferred to American film"],a:0,d:4},{q:"In Saw III, what is Dr. Lynn Denlon's trap?",o:["A collar bomb that detonates if John Kramer dies","The Rack — a limb-twisting full body contraption","A sealed razor box she must dig her way out of it","A drill chair that activates in exactly one hour"],a:0,d:4},{q:"What is distinctive about Art the Clown's performance style in Terrifier?",o:["He is a silent mime-clown — he never speaks but communicates entirely through exaggerated physical performance alone","He is a traditional circus clown whose dialogue draws directly from the classic American rodeo performance tradition of the 1950s","He is based on a real street performer Damien Leone observed in downtown New York City for several years prior to writing the character","He wears a realistic human face mask instead of traditional clown makeup — the mask was designed to sit uncannily between real and fake"],a:0,d:4},{q:"Why did the directors of Scream 6 choose New York City as the setting?",o:["They wanted a bigger more anonymous city where Ghostface could hide in plain sight among millions of strangers","They wanted to avoid the Woodsboro setting entirely and chose NYC because it felt thematically opposite to every prior film","They wanted to capitalize on the surviving characters' college storyline — the characters had all moved there together recently","They wanted to bring Ghostface to a new coast — producers felt West Coast settings had become stale across the franchise's run"],a:0,d:4}];
const Q4c1=[{q:"What historical figure shares the name of the killer in Eli Roth's Thanksgiving?",o:["John Carver — the real first governor of Plymouth Colony","John Alden — a famous real Mayflower passenger and settler","John Hanson — the first President under the Articles union","John Wheelwright — a real Puritan minister from Massachusetts"],a:0,d:2},{q:"What was the box office of Saw making it one of history's most profitable?",o:["$103 million worldwide on a $1.2 million budget","$200 million worldwide on a $2 million budget","$55 million worldwide on a $500k budget alone","$75 million worldwide on a $3 million budget"],a:0,d:4}];
const Q4c2=[{q:"What is the original Italian title of Mario Bava's Bay of Blood (1971)?",o:["Reazione a Catena","Ecologia del Delitto","La Baia Insanguinata","Sangue della Laguna"],a:0,d:1},{q:"What does the final girl trope typically require of the surviving female character?",o:["She is typically sexually abstinent and more resourceful than her peers","She is always the prettiest and most athletic woman among the victims","She is always the strongest fighter who defeats the killer in combat","She always has a deeply tragic family backstory that drives the plot"],a:0,d:1},{q:"What 1986 slasher subverts the genre by revealing all the deaths were staged as a prank?",o:["Slaughter High","April Fool's Day","Happy Birthday to Me","Prom Night"],a:1,d:1},{q:"Who directed the original Saw (2004)?",o:["Leigh Whannell", "James Wan", "Greg Hoffman", "Gregg Hoffman"],a:1,d:4},{q:"What studio passed on distributing A Nightmare on Elm Street, allowing New Line Cinema to pick it up and launch their company?",o:["Embassy Pictures","Warner Bros Pics","Columbia Studios","Paramount Ltd."],a:0,d:4}];
const Q4c3=[{q:"What specific scene in Halloween required the most setups and time to film?",o:["The opening POV shot", "The final confrontation", "The closet scene with Laurie", "The kitchen scene"],a:0,d:4},{q:"Who played Michael Myers in Halloween: H20?",o:["Chris Durand", "Brad Loree", "Tyler Mane", "George P. Wilbur"],a:0,d:4},{q:"What is the exploitation film distribution circuit that pre-dated the slasher's?",o:["Standard theaters", "The grindhouse circuit", "Drive-in only", "Television only"],a:0,d:4},{q:"In Candyman (1992), what is the Cabrini-Green used as symbolically?",o:["Racial tension and forgotten communities","Supernatural evil hiding in urban decay","Government failures in housing policy work","The slow death of American urban life today"],a:0,d:4}];
const Q4c5=[{q:"Which Ari Aster film is most directly compared to the slasher genre despite not being one?",o:["Beau is Afraid","Midsommar","Hereditary","All of them equally"],a:2,d:4},{q:"What was the original title of Scream?",o:["Scary Movie","Slashed Open","Shockers III","Slay Bells"],a:0,d:4},{q:"What year is The Black Phone set in, and why does it matter to the story?",o:["1968 — before child abduction awareness existed","1978 — the same year Halloween was released","1988 — during the height of Satanic Panic fears","1958 — before video technology would aid rescue"],a:0,d:4}];
const Q4c6=[{q:"What has Clive Barker said about the slasher genre compared to his own work?",o:["Barker has said slashers reduce horror to mechanics — his work focuses on desire and transformation rather than simple stalking and killing","Barker has said slashers are the purest distillation of horror — he has cited Halloween and Friday the 13th as influences on Hellraiser itself","Barker has said he has never watched a single American slasher film and that all his influences come from European and Asian horror cinema only","Barker has said slashers are primarily marketing exercises aimed at teenagers — he considers his own work to exist in a separate genre category entirely"],a:0,d:4}];
const Q4c7=[{q:"What was the budget of A Nightmare on Elm Street?",o:["$850,000", "$1.1 million", "$1.8 million", "$3 million"],a:2,d:4}];
const Q4c8=[{q:"What is the name of Michael Myers' doctor at Smith's Grove before Dr. Loomis?",o:["Dr. Terrence Wynn","Dr. Gerald Mixter","Dr. Howard Ellis","Dr. Richard Ross"],a:0,d:4},{q:"What decade does Ti West's The House of the Devil deliberately evoke in its style?",o:["The 1960s","The 1970s","The 1980s","The 1990s"],a:2,d:4}];
const Q4c9=[{q:"What is the budget of the original A Nightmare on Elm Street?",o:["$1.1 million", "$1.8 million", "$2.5 million", "$3.5 million"],a:1,d:4},{q:"What is the blood ceiling effect in Nightmare on Elm Street?",o:["The entire bedroom set was built to rotate","A split-screen trick blended two camera feeds","A pressurized wire rig dumped the blood down","A practical dump tank above the ceiling opened"],a:0,d:4}];
...
const Q4c11=[{q:"What is the Michael Myers Theme's full orchestral instrumentation?",o:["Piano synthesizer bass drums and high strings","A full orchestra of strings horns and timpani","Mostly synthesizer with occasional horns added","Piano solo with no other instrumentation used"],a:0,d:4},{q:"What is unique about Chucky and Tiffany's child in Seed of Chucky?",o:["Gender non-conforming", "Is born human", "Has supernatural powers", "Has two souls"],a:0,d:4}];
const Q4c12=[{q:"What did Simon Barrett do on You're Next beyond writing the screenplay?",o:["Barrett wrote the script and extensively researched home invasion survival tactics to make Erin's abilities feel plausible and real","Barrett wrote the script and directed all the second unit photography himself during principal production to save time and money on the shoot","Barrett wrote the script and co-composed the film's electronic synth score alongside his college friend and frequent collaborator Jasper Justice","Barrett wrote the script and personally scouted every rural Missouri filming location himself over the course of a full year before production began"],a:0,d:4},{q:"What was unusual about how Kane Hodder physically designed Victor Crowley for Hatchet?",o:["Hodder worked with Adam Green to give Crowley distinct animalistic physicality — different from Jason — emphasizing raw feral rage rather than Jason's slow stalking approach from the films","Hodder insisted Crowley walk identically to Jason Voorhees to directly honor his previous horror icon performances — Adam Green agreed and choreographed every scene to match","Hodder designed Crowley's movements around his real-life martial arts training in judo and hapkido — every kill scene incorporated actual authentic throws from those disciplines","Hodder performed all of Crowley's kills without any choreography or blocking — every scene was fully improvised between Hodder and Adam Green on the day of the shoot in Louisiana"],a:0,d:4},{q:"What was the budget of Freddy vs. Jason and why was it significant?",o:["At approximately $30 million it was the most expensive film either franchise had produced — a gamble justified by the crossover event's unique marketing appeal","At approximately $10 million it was actually the cheapest film either franchise had made in its entire run — a testament to the producers' cost-cutting innovations","At approximately $15 million it was the standard Hollywood mid-budget for early 2000s genre films — nothing about the production was financially remarkable in any way","At approximately $75 million it rivaled major studio tentpole releases of that era — New Line bet heavily on this film being a summer blockbuster crossover event"],a:0,d:4}];
const Q4c13=[{q:"What is Alan B. McElroy's connection to the Wrong Turn franchise?",o:["He wrote the original 2003 Wrong Turn but had no involvement in the sequels or the 2021 reboot","He wrote and directed the original 2003 Wrong Turn and returned to write the 2021 reboot installment","He produced all seven entries in the Wrong Turn franchise from the original film through the reboot","He wrote the 2021 Wrong Turn reboot but had no involvement in the original film or the earlier sequels"],a:0,d:4},{q:"What did Wes Craven say about the relationship between his personal life and his horror films?",o:["Craven stated in interviews that his films were direct expressions of his fears and his Calvinist upbringing — horror was his way of processing personal religious trauma","Craven insisted publicly that his horror work had no personal connection at all to his life — he viewed each project as a purely commercial genre exercise without meaning","Craven argued throughout his career that personal expression would always weaken horror cinema — he believed the genre worked best when the filmmaker remained detached entirely","Craven maintained that his horror films drew exclusively from urban legends and news stories — he denied any autobiographical element in his work during many late-career retrospective interviews"],a:0,d:4}];
const Q4c14=[{q:"What is the first trap shown in Saw (2004)?",o:["The Reverse Bear Trap — Amanda must retrieve a key from a dead man's stomach","The Bathroom Trap — two men chained to pipes with a single hacksaw between them","The Venus Fly Trap — a man with glass shards in his eyes chained to a rusted door","The Shotgun Collar Trap — a woman must pass a key through a pitch dark maze below"],a:0,d:4},{q:"What is the origin of Harry Manfredini's ki ki ki ma ma ma sound in Friday the 13th?",o:["It is Manfredini's own voice processed through a delay effect — representing the words kill kill kill mom mom mom mom","It is a tape loop of a clarinet reed being rubbed against a microphone — stretched and layered to create an uncanny rhythmic pulse","It is a synthesizer patch designed to mimic the sound of a wolf breathing heavily — Manfredini built it from scratch on an early Moog synthesizer","It is a field recording of crickets slowed down by eight times — Manfredini stumbled on it while scoring an earlier film for New Line Cinema pictures"],a:0,d:4}];
const Q4c15=[{q:"What are the Sawyer family members' names in Texas Chain Saw Massacre 2?",o:["Drayton, Chop-Top, Leatherface and Tinker","Drayton, Chop-Top, Leatherface and Nubbins","Drayton, Leatherface, Stretch and Tex Jr","Chop-Top, Leatherface, Tex and Old Man Sawyer"],a:0,d:4},{q:"What is Chop-Top's distinguishing feature in Texas Chain Saw Massacre 2?",o:["A metal plate in his head that he picks at with a wire hanger","A hook for a hand that he uses to shred meat at the hideout","A glass eye that he has replaced with a taxidermied owl's eye","A prosthetic leg that he carved himself from bone and tarnished wood"],a:0,d:4},{q:"In Wes Craven's New Nightmare, who plays herself fighting Freddy?",o:["Patricia Arquette","Lisa Wilcox","Heather Langenkamp","Tuesday Knight"],a:2,d:4},{q:"In Sleepaway Camp 2 and 3, who plays Angela Baker?",o:["Pamela Springsteen","Felissa Rose Jr.","Karen Fields Allen","Susan Tyrrell II"],a:0,d:4},{q:"What is the budget of the original Saw?",o:["$1.2 million","$800 thousand","$2.5 million","$500 thousand"],a:0,d:4},{q:"What did Todd McFarlane's Movie Maniacs toy line contribute to slasher culture?",o:["McFarlane's Movie Maniacs line produced highly detailed figures of Freddy, Jason, Leatherface and others — turning slasher villains into premium collectibles","McFarlane directly produced three of the 1990s Friday the 13th sequels alongside Sean Cunningham — his production work helped redefine the franchise for a new era of fans","McFarlane wrote the novelizations of every major slasher film released in the 1990s — his books were major bestsellers that introduced a whole new generation to the classics","McFarlane served as the studio executive who green-lit the Scream franchise at Dimension Films — his business decisions reshaped the slasher landscape during the late 1990s era"],a:0,d:4},{q:"What did Stephen King's non-fiction book Danse Macabre contribute to slasher studies?",o:["King's Danse Macabre provided one of the first serious critical frameworks for analyzing horror including early slasher cinema and its cultural meaning","King's Danse Macabre was a novelization collection of his own short fiction that served as direct source material for several 1980s and 1990s slasher adaptations","King's Danse Macabre was an exhaustive historical encyclopedia of every horror film ever made — slashers were listed alongside creature features and ghost stories equally","King's Danse Macabre was a sustained public attack on the entire slasher subgenre as being lowbrow and exploitative — the book was controversial among horror fans of that era"],a:0,d:4},{q:"What is Steve Miner's key contribution to the Friday the 13th franchise?",o:["Miner directed Parts 2 and 3 which established Jason as the franchise's killer and gave him his hockey mask — defining the franchise's entire visual identity for decades","Miner directed Part 4 The Final Chapter and introduced Jason's trademark machete as his signature weapon — the film remains one of the most financially successful entries","Miner directed Part 6 Jason Lives and introduced the supernatural zombie Jason that dominated every sequel that followed — changing the mythology permanently for audiences","Miner directed Part 8 Jason Takes Manhattan and pioneered the use of urban setting for the franchise — the film's location work in New York influenced many later sequels"],a:0,d:4},{q:"How does Freaky (2020) relate to the slasher genre?",o:["Freaky is a slasher filtered through a body-swap comedy — it uses all the classic slasher mechanics while being hilarious and genuinely scary at the same time","Freaky is a straight comedy film with no real slasher elements — it references classic slasher tropes but plays as a high school romance about identity and self-discovery","Freaky is a horror film that deliberately avoids slasher conventions — it presents itself as a dark psychological thriller about trauma rather than a fun body-count genre piece","Freaky is a dramatic character study unrelated to the slasher subgenre — it uses horror imagery as a backdrop for a meditation on adolescence in modern American high schools"],a:0,d:4},{q:"What production decision made Halloween H20 feel like a genuine new chapter?",o:["The decision to ignore all Halloween sequels after II and connect directly back to the original — giving Jamie Lee Curtis a meaningful return role","The decision to fully reboot the franchise with a new director cast and setting — nothing from the prior films was kept beyond the name Michael Myers himself","The decision to retain every sequel in continuity and merge them all into a final confrontation — the film references events from Halloweens 4, 5 and 6 throughout","The decision to completely abandon the original Halloween mythology — the film establishes Laurie as a new character in a fresh timeline with no narrative connection"],a:0,d:4},{q:"Who is generally considered the most iconic slasher villain?",o:["Jason Voorhees","Michael Myers","Freddy Krueger","Ghostface"],a:1,d:4}];
const Q4c22=[{q:"In Bride of Chucky, what kills Chucky and Tiffany initially?",o:["Chucky is stabbed by Tiffany","Both are stabbed at the same time","Both drown in a river rescue","They are burned in a bonfire"],a:0,d:4},{q:"What is the practical effects technique in Terrifier's most extreme kills?",o:["All practical in-camera effects using prosthetics","A roughly equal mix of practical and CGI work","CGI digitally enhanced to replace practical rigs","Fully computer generated gore done in post only"],a:0,d:4}];
const Q4c23=[{q:"What does Joe Hill's source story for The Black Phone do that the film preserves?",o:["Hill's prose grounds supernatural horror in the specific texture of 1970s working-class childhood — the film preserves this through period detail, casting and the tactile ordinariness of every location","Hill's prose focuses almost entirely on the killer's perspective and inner monologue — the film preserves this voice through extensive voiceover narration spoken directly by the actor playing the Grabber throughout","Hill's prose is written in a stripped-down minimalist style reminiscent of Raymond Carver — the film preserves this through long dialogue-free sequences and intentionally static camera work that mirrors the prose pace directly","Hill's prose employs nested unreliable narrators who contradict each other — the film preserves this by splitting its story between three different conflicting accounts of the same events told by each of its main characters"],a:0,d:4},{q:"What is the tragic irony at the core of Victor Crowley's origin in Hatchet?",o:["He is doomed to relive his death forever — killed accidentally by his own loving father who was trying to save him from a burning shed","He is doomed to watch his killer walk free forever — the man who murdered him in life was never caught by the local Louisiana authorities","He is doomed to hunt the descendants of his real killers forever — the original bullies who drowned him have been long dead for several generations now","He is doomed to protect the swamp from trespassers forever — a curse placed on him by a local voodoo practitioner he had wronged in his childhood years"],a:0,d:4}];
const Q4c24=[{q:"What does the Chucky TV series do for the franchise mythology that the films could not?",o:["The long-form TV format allows Chucky to inhabit multiple hosts simultaneously and gives supporting characters like Tiffany Andy and Kyle full character arcs that the feature films could never fully develop given their 90-minute runtime","The long-form TV format lets the series operate as a complete reboot of the franchise that ignores every previous film — the show establishes its own self-contained continuity with new characters and fresh backstory unrelated to the original Child's Play series of films","The long-form TV format restricts the level of graphic violence compared to the R-rated theatrical films — the show trades visceral gore for slower psychological horror built across episodes rather than in single confined climactic scenes like each film has","The long-form TV format permits the show to explore only one killing per season in great forensic detail — every episode is told from multiple contradicting perspectives of a single murder committed by Chucky in the town where each season takes place in a fictional setting"],a:0,d:4},{q:"What is Damien Leone's key achievement with the Terrifier films?",o:["Leone achieved extreme professional-grade practical gore effects on micro-budgets — Terrifier cost around $35 thousand and Terrifier 2 cost around $250 thousand","Leone secured a series of rising studio budgets across the Terrifier franchise — each sequel received roughly double the financing of the previous installment at the box office","Leone was given an enormous initial budget by independent horror financiers — the films cost upwards of $10 million each despite their deliberately rough low-budget aesthetic","Leone relied extensively on modern digital compositing and CGI to stretch a modest budget — the apparent practical effects in the Terrifier films are largely computer-generated in post"],a:0,d:4}];
const Q4c25=[{q:"What actor plays Candyman in the original 1992 film?",o:["Tony Todd","Keith David","Ernie Hudson","Bill Nunn"],a:0,d:4},{q:"What was the production budget of the original Candyman (1992)?",o:["Around $500,000","Around $800,000","Approximately $1.2 million","Approximately $8 million"],a:3,d:4}];
const Q4c26=[{q:"What was James Wan's directorial feature debut?",o:["Insidious","Dead Silence","Saw","The Conjuring"],a:2,d:4}];
const Q4c27=[{q:"What is the influence of Ingmar Bergman on Wes Craven's directorial style?",o:["The use of dream logic and psychological terror as legitimate cinematic language — Craven studied Bergman's films extensively while developing his own approach to horror","The use of a very specific color palette inspired by Bergman's The Seventh Seal — Craven adopted those exact tones in his own early work on The Last House on the Left","The use of long unbroken single-take sequences during emotionally charged moments — Craven borrowed this technique from Persona for several key scenes in later films","The use of dense intellectual dialogue scenes between every violent moment — Craven emulated Bergman's literary sensibility throughout A Nightmare on Elm Street specifically"],a:0,d:4}];
const Q4c28=[{q:"What is the Evil Dead Rise innovation?",o:["Evil Dead Rise introduces a vinyl record version of the Necronomicon incantations — updating the cassette tapes of the earlier Evil Dead films for modern audiences","Evil Dead Rise introduces a fully digital Necronomicon that exists only as a computer program — the possession spreads through the devices of every character who opens the file","Evil Dead Rise introduces a live-streamed Necronomicon ritual being broadcast online — the possession spreads through millions of viewers who watched the video before it was taken down","Evil Dead Rise introduces a Necronomicon audiobook delivered via headphones — the possession spreads through each character who hears specific passages read aloud by a narrator"],a:0,d:4}];
const Q4c29=[{q:"What challenge did the original Child's Play face in marketing that it had to overcome?",o:["How to sell a horror film centered on a children's toy without alienating parents buying toys for kids","How to compete with Halloween 4 at the same weekend box office without losing theatergoers to Carpenter's sequel","How to reach broader adult audiences who might dismiss a film about a killer doll as too silly to take seriously at all","How to market a film with extreme graphic onscreen violence to mainstream audiences without attracting MPAA censorship trouble"],a:0,d:4},{q:"What production design philosophy did Tobe Hooper bring to The Texas Chain Saw Massacre?",o:["A raw newsreel aesthetic — he wanted it to look like documentary footage of something that actually happened","A stylized Gothic look borrowed directly from the Hammer horror films of the 1960s and 70s cinematic traditions","A classical Hollywood three-point lighting setup with deep focus compositions during every single interior scene","A heavily theatrical staging approach with deliberately artificial backdrops in every single exterior shot sequence"],a:0,d:4}];
const Q4c30=[{q:"What is the name of Angela's real surname in Sleepaway Camp?",o:["Baker", "Johnson", "Sherry", "Phillips"],a:0,d:4}];
const Q4c31=[{q:"What makes the 2021 Wrong Turn reboot fundamentally different from the original?",o:["The killers are now a hidden commune not inbred cannibals","It is set in a major city and not the Appalachian mountains","The film has a much bigger Hollywood studio budget this time","There are no killings or kills at all in the 2021 reboot film"],a:0,d:4}];
const Q4c32=[{q:"Who directed The Texas Chain Saw Massacre 2 (1986)?",o:["Kim Henkel", "Tobe Hooper", "Jeff Burr", "Marcus Nispel"],a:1,d:4},{q:"What decade does MaXXXine pay homage to through its aesthetic and setting?",o:["The 1970s","The 1980s","The 1990s","The 2000s"],a:1,d:4}];
const Q4c33=[{q:"What is the Roy Burns reveal mechanism in Friday Part V?",o:["Roy Burns is a paramedic copycat","The twist comes through a flashback","A standard final act unmasking scene","An ending that sets up the sequel film"],a:0,d:4},{q:"Who composed the score for Tourist Trap?",o:["Pino Donaggio","Harry Manfredini","John Carpenter","Ennio Morricone"],a:0,d:4},{q:"Which famous actor appeared early in their career in The Burning?",o:["Jason Alexander","Fisher Stevens","Holly Hunter Jr.","Kevin Bacon II"],a:0,d:4},{q:"Who plays the killer in Maniac 1980?",o:["Tom Savini","Joe Spinell","Michael Moriarty","Anthony Perkins"],a:1,d:4},{q:"What special power does the killer have in Tourist Trap?",o:["Super strength","Telekinesis","Invisibility","Pyrokinesis"],a:1,d:4},{q:"Where is Intruder 1989 primarily set?",o:["A hospital","A supermarket","A shopping mall","A school"],a:1,d:4},{q:"Who has a cameo in Intruder 1989?",o:["Bruce Campbell and Sam Raimi","John Carpenter Wes Craven","Stephen King and Clive Barker","Tobe Hooper and Dan O'Bannon"],a:0,d:4},{q:"What studio produced The Burning (1981)?",o:["Paramount","Miramax","Filmways","New Line Cinema"],a:2,d:4},{q:"Who directed Graduation Day 1981?",o:["Herb Freed","Alan Birkinshaw","Jim Sotos","Tom DeSimone"],a:0,d:4},{q:"Who did Stage Fright (1987) director Michele Soavi study under?",o:["Dario Argento","Lucio Fulci","Mario Bava","Federico Fellini"],a:0,d:4},{q:"What camp is The Burning set at?",o:["Camp Crystal Lake","Camp Blackfoot","Camp Stonewater","Camp Tillerman"],a:1,d:4},{q:"Who directed Happy Birthday to Me?",o:["J. Lee Thompson","Brian De Palma","Richard Fleischer","John Frankenheimer"],a:0,d:4},{q:"What studio backed the X trilogy?",o:["A24","Blumhouse","Neon","Lionsgate"],a:0,d:4},{q:"Who did the special effects for Intruder 1989?",o:["Tom Savini","KNB EFX Group","Rob Bottin","Greg Nicotero"],a:1,d:4},{q:"What is the Slaughter High killer's motive?",o:["Revenge for a prank that disfigured him","A demonic possession by a local cult","Grief over his parents' sudden murder","Escape from a wrongful prison sentence"],a:0,d:4},{q:"Who plays ChromeSkull in Laid to Rest?",o:["Nick Principe","Kane Hodder","Tyler Mane","Robert Englund"],a:0,d:4},{q:"Where was Pieces 1982 filmed?",o:["Spain","Italy","USA","UK"],a:0,d:4},{q:"What actress played Esther in Orphan?",o:["Dakota Fanning","Isabelle Fuhrman","Chloe Grace Moretz","Abigail Breslin"],a:1,d:4},{q:"What is Esther's real name in Orphan?",o:["Leena Klammer","Anna Voronova","Marta Fischer","Vera Farmiga"],a:0,d:4},{q:"What Stephen King novel did Mike Flanagan adapt in 2017?",o:["Gerald's Game","Pet Sematary","The Shining II","Doctor Sleep"],a:0,d:4}];
const Q5c0=[{q:"What Psycho element most directly influenced the slasher genre?",o:["The shower scene establishing the protagonist can die early","The transformation of an ordinary motel into a place of horror","Bernard Herrmann's strings-only score setting the template","Norman Bates' split personality as a psychological horror base"],a:0,d:1},{q:"What slasher film features a killer who stalks victims in an amusement park?",o:["The Funhouse","Carnival of Souls","Killer Klowns from Outer Space","The Funhouse Massacre"],a:0,d:1},{q:"What made My Bloody Valentine 3D (2009) technically notable?",o:["The film used digital 3D rather than the older analog polarized process","The film was shot using the same Fusion cameras that James Cameron used for Avatar","The film used a brand new proprietary stereoscopic camera rig developed in-house","The film was the first horror movie ever to be shot entirely in a stereoscopic format"],a:0,d:1},{q:"What is the Italian original title of Bay of Blood?",o:["Reazione a Catena","Il Lago di Sangue","Ecologia del Delitto","La Baia del Morto"],a:0,d:5},{q:"What is the name of the disease that inspired Freddy Krueger's backstory?",o:["Asian Death Syndrome (SUNDS)","Night terror disorder onset","REM behavior disorder sleep","Brugada cardiac syndrome"],a:0,d:5}];
const Q5c2=[{q:"In The Shining, what room does the Overlook Hotel warn Jack never to enter?",o:["Room 217","Room 237","Room 666","Room 101"],a:1,d:1},{q:"What did the Italian Giallo genre contribute to the slasher's visual style?",o:["The aestheticization of killing through stylized camerawork","The masked killer trope that defined 1980s American cinema","The POV camera technique used from a killer's perspective","The narrative structure of a small-town serial killer plot"],a:0,d:1},{q:"What 1932 film is considered a proto-slasher with a killer targeting women?",o:["Thirteen Women","White Zombie ","Murder! by AH","Freaks Browning"],a:0,d:5},{q:"What is the Japanese term for the slasher genre?",o:["Satsujin eiga", "Kirisaki eiga", "Horaa", "Surassha eiga"],a:3,d:5}];
const Q5c5=[{q:"What film is widely credited as the first slasher movie?",o:["Psycho", "Peeping Tom", "A Bay of Blood", "Halloween"],a:1,d:5}];
const Q5c6=[];
const Q5c7=[{q:"What Argento film predates Halloween and features POV killer shots?",o:["The Bird with the Crystal Plumage","Four Flies on Grey Velvet film","Deep Red — Profondo Rosso movie","The Cat o' Nine Tails thriller"],a:0,d:5},{q:"What is the Leigh Whannell statement about the short film that preceded Saw?",o:["The bathroom test short was made to attract investors","The short film was made for a school project assignment","The short was rejected by every major investor they met","They never made a short film before the Saw feature began"],a:0,d:5},{q:"What is the real-life camp where parts of Friday the 13th were filmed?",o:["Camp No-Be-Bo-Sco","Camp Crystal Lake in Blairstown NJ","Camp Ockanickon","Camp Hillard"],a:0,d:5},{q:"What distinguished Friday the 13th's marketing campaign?",o:["A national TV campaign unprecedented for a slasher","Advance screenings for critics were totally banned","The film relied exclusively on word of mouth buzz","Tie-in merchandise was released alongside the film"],a:0,d:5},{q:"What slasher franchise features a killer named Chromeskull?",o:["Laid to Rest","Wrong Turn","Terrifier","The Prowler"],a:0,d:5},{q:"What is the name of the killer in Sleepaway Camp?",o:["Angela Baker","Karen Hill","Judy Martin","Ricky Thomas"],a:0,d:5},{q:"What is the name of the camp in Sleepaway Camp?",o:["Camp Arawak","Camp Crystal Lake","Camp Blackfoot","Camp Redwood"],a:0,d:5},{q:"What is the original Italian title of Argento's The Bird with the Crystal?",o:["L'uccello dalle piume di cristallo","Il gatto a nove code di Argento","Quattro mosche di velluto grigio","Profondo Rosso hatchet murders"],a:0,d:5}];
const Q5c14=[{q:"Who is Amanda Krueger in the Nightmare on Elm Street mythology?",o:["A nun who was locked in an asylum with the criminally insane over Christmas and assaulted — making Freddy the bastard son of a hundred maniacs","A young schoolteacher who was murdered by the angry Elm Street parents who mistakenly believed she had been hiding Freddy in her classroom during the hunt","A local physician who treated Freddy as a child and became the only person who knew about his sadistic tendencies — her death in a car crash freed him forever","A vigilante leader who initially organized the burning of Freddy Krueger — her guilt over the act later made her take her own life on the very same night each year"],a:0,d:5}];
const Q5c17=[{q:"What MPAA rating controversy surrounded the original Halloween's release?",o:["It was released unrated then re-submitted for R","It was initially rated X by the MPAA ratings board","It was banned outright in several American US states","The ratings board demanded exactly 15 cuts to approve"],a:0,d:5}];
const Q5c19=[{q:"What slasher film features a killer motivated by a botched medical procedure?",o:["Tourist Trap", "Dr. Giggles", "The Dentist", "Visiting Hours"],a:1,d:5},{q:"What is the career of the killer in Peeping Tom?",o:["A cameraman and focus puller","A well-known photographer","A movie critic and writer","An independent film director"],a:0,d:5},{q:"What director made both Piranha and The Howling?",o:["Joe Dante","John Carpenter","Wes Craven","Tobe Hooper"],a:0,d:5}];
const Q5c24=[];
const Q5c25=[{q:"Who is the first person to die on screen in Black Christmas 1974?",o:["Barb", "Clare", "Phyllis", "Jess"],a:1,d:3}];
const Q5c28=[{q:"What is the Kevin Williamson stated anxiety that motivated the Scream script?",o:["Fear of violence", "He was alone in a house", "He wanted to critique horror", "He wanted to make money"],a:1,d:5}];
const Q4c34=[{q:"What was the original title of Friday the 13th in development?",o:["Camp Blood","Long Night at Camp Blood","Slice of Life","The 13th"],a:0,d:5},{q:"What is the budget of Halloween 1978 and why is it significant?",o:["$325,000 — proving horror could profit on minimal budgets","$2 million — unusually high budget for an indie horror film","$500,000 — below the average for independent film productions","$1 million — right at the mid-range for the era's horror films"],a:0,d:5},{q:"How many Friday the 13th films did Sean Cunningham actually direct?",o:["Only the original Friday the 13th","Three — he directed the first three","He directed all twelve","He produced them all but directed none after the first"],a:0,d:5},{q:"In Halloween II (1981), where does most of the film take place?",o:["Haddonfield Memorial Hospital","The old abandoned Myers house","Haddonfield Central High School","The Haddonfield police station"],a:0,d:1},{q:"What is revealed about Laurie and Michael's relationship in Halloween II (1981)?",o:["They are neighbors","She is his sister","They are childhood friends","She is his former babysitter"],a:1,d:1},{q:"Who plays Laurie Strode in Halloween H20 (1998)?",o:["Scout Taylor-Compton","Danielle Harris","Jamie Lee Curtis","Michelle Williams"],a:2,d:1},{q:"How does Laurie kill Michael at the end of Halloween H20?",o:["She decapitates him with a fire axe","She shoots him with her father's gun","She burns him alive in a car fire","She stabs him with a kitchen knife"],a:0,d:1},{q:"Who is Jamie Lloyd in the Halloween franchise?",o:["A random victim","Laurie Strode's daughter","Michael's niece from another family","Laurie's sister"],a:1,d:1},{q:"Who plays Jamie Lloyd in Halloween 4 and 5?",o:["Drew Barrymore","Scout Taylor-Compton","Danielle Harris","Heather Langenkamp"],a:2,d:1},{q:"What does Jamie do at the end of Halloween 4 that mirrors the original film's opening?",o:["She stabs her foster mother while wearing a clown costume","She hides silently inside a bedroom closet while sirens blare","She escapes by getting on a bus leaving Haddonfield behind","She kills the family dog with a pair of her grandmother's scissors"],a:0,d:1},{q:"Who plays Michael Myers in Rob Zombie's Halloween (2007)?",o:["Brad Loree","George P. Wilbur","Tyler Mane","Chris Durand"],a:2,d:1},{q:"Who plays Laurie Strode in Rob Zombie's Halloween (2007)?",o:["Jamie Lee Curtis","Danielle Harris","Scout Taylor-Compton","Sherri Moon Zombie"],a:2,d:1},{q:"In Halloween (2018), what is retconned about Laurie and Michael's relationship?",o:["They are revealed to be twins","They are no longer siblings","She becomes his mother figure","They are revealed to be cousins"],a:1,d:1},{q:"Who directed Halloween (2018)?",o:["David Gordon Green","Mike Flanagan Jr.","James Wan Director","Rob Zombie Sr."],a:0,d:1},{q:"What alias is Laurie Strode living under in Halloween H20?",o:["Laura Kraft","Keri Tate","Lisa Myer","Mary Haddon"],a:1,d:1},{q:"What is the name of the new killer introduced in Halloween Ends (2022)?",o:["Corey Cunningham","Frank Hawkins Jr","Tommy Doyle II","Lonnie Elam Sr"],a:0,d:1},{q:"In Halloween Kills (2021), what do the people of Haddonfield form to fight Michael?",o:["A police squad","An angry mob","A militia","A trap"],a:1,d:1},{q:"What year was Halloween 4: The Return of Michael Myers released?",o:["1986","1987","1988","1989"],a:2,d:1},{q:"What is the setting of Halloween III: Season of the Witch?",o:["A sinister Halloween mask company","A haunted high school reunion dance","A cursed summer camp by the lake","A possessed small town candy factory"],a:0,d:1},{q:"Who directed Halloween II (1981)?",o:["John Carpenter","Tommy Lee Wallace","Rick Rosenthal","Dwight H. Little"],a:2,d:2},{q:"What is the name of the sinister company in Halloween III: Season of the Witch?",o:["Black Thorn","Silver Shamrock","Dark Star","Thorn Industries"],a:1,d:2},{q:"In Halloween III, what is hidden inside each Silver Shamrock mask?",o:["A piece of Stonehenge that triggers a deadly signal","A tiny GPS tracker tied to the wearer's heart rate","A vial of nerve agent released by the TV broadcast","A microchip controlling the wearer's body movements"],a:0,d:2},{q:"Who directed Halloween III: Season of the Witch?",o:["John Carpenter","Rick Rosenthal","Tommy Lee Wallace","Dwight H. Little"],a:2,d:2},{q:"Who directed Halloween 4: The Return of Michael Myers?",o:["Rick Rosenthal","Tommy Lee Wallace","Dwight H. Little","Joe Chappelle"],a:2,d:2},{q:"What is the mysterious mark both Michael Myers and Jamie share in Halloween 5?",o:["A birthmark","The Thorn rune","A scar on the wrist","A tattoo"],a:1,d:2},{q:"Who plays Dr. Loomis across Halloween 4, 5, and 6?",o:["Tom Atkins","Malcolm McDowell","Donald Pleasence","Clint Howard"],a:2,d:2},{q:"In Rob Zombie's Halloween, who plays Dr. Loomis?",o:["Donald Pleasence","Brad Dourif","Malcolm McDowell","Clint Howard"],a:2,d:2},{q:"What controversial scene opens Halloween: Resurrection (2002)?",o:["Laurie Strode is killed in a psychiatric hospital","Michael Myers is seen escaping from state prison cell","Jamie Lloyd returns from the dead in a surprise scene","Michael Myers is unmasked by the local police detective"],a:0,d:2},{q:"What is the premise of Halloween: Resurrection (2002)?",o:["Internet reality show contestants spend the night in the Myers house","Laurie Strode's long-lost daughter tracks Michael across the countryside","Michael Myers travels to a completely new city in search of fresh victims","Michael Myers returns to Haddonfield for one final bloody apocalyptic showdown"],a:0,d:2},{q:"Who plays John Tate, Laurie's son, in Halloween H20?",o:["Paul Rudd","Devon Sawa","Josh Hartnett","Skeet Ulrich"],a:2,d:2},{q:"What actor originally played Michael Myers in the 1978 Halloween?",o:["Dick Warlock","George P. Wilbur","Nick Castle","Tyler Mane"],a:2,d:2},{q:"What is the name of Laurie Strode's daughter in Halloween (2018)?",o:["Jamie","Rachel","Karen","Allyson"],a:2,d:2},{q:"In Halloween Ends, how does Michael Myers ultimately die?",o:["He is killed then put through an industrial shredder","He is shot in the head by Corey at the final moment","He burns to death in a long chained factory inferno","He drowns in the river behind the old Myers property"],a:0,d:2},{q:"What is the Thorn cult's purpose in Halloween 6?",o:["To control Michael through an ancient rune curse","To physically resurrect Mrs. Voorhees' ancient spirit","To protect Haddonfield from Michael's nightly attacks","To permanently worship Michael as a vengeful pagan god"],a:0,d:2},{q:"In A Nightmare on Elm Street 3, what are the teens who fight Freddy called?",o:["The Elm Street Kids","The Dream Warriors","The Freddy Fighters","The Last Dreamers"],a:1,d:1},{q:"In A Nightmare on Elm Street 3, who returns from the original film to help the teens?",o:["Nancy Thompson","Jesse Walsh Jr","Kristen Parker","Alice Johnson"],a:0,d:1},{q:"What is the subtitle of A Nightmare on Elm Street 3?",o:["Dream Master","Dream Warriors","Freddy's Revenge","The Dream Child"],a:1,d:1},{q:"In Nightmare on Elm Street 4, who is the new Dream Master?",o:["Kristen","Alice","Nancy","Debbie"],a:1,d:1},{q:"What is Freddy's most famous one-liner from A Nightmare on Elm Street 3?",o:["You're all my children now","Welcome to prime time, bitch","How's this for a wet dream?","This is it, Jennifer — your big break in TV"],a:1,d:1},{q:"In Freddy's Dead: The Final Nightmare, who is revealed to be Freddy's daughter?",o:["Alice","Nancy","Maggie","Lisa"],a:2,d:1},{q:"What is the subtitle of Nightmare on Elm Street 5?",o:["The Dream Master","The Dream Child","The Final Nightmare","Freddy's Revenge"],a:1,d:1},{q:"In Wes Craven's New Nightmare (1994), who plays herself being stalked by Freddy?",o:["Patricia Arquette","Lisa Wilcox","Tuesday Knight","Heather Langenkamp"],a:3,d:1},{q:"In A Nightmare on Elm Street Part 2, who does Freddy try to possess to kill in the real world?",o:["Jesse Walsh","Lisa Webber","Ron Grady","Kerry Hope"],a:0,d:2},{q:"What is the subtitle of A Nightmare on Elm Street Part 2?",o:["Dream Warriors","Freddy's Revenge","The Dream Master","Freddy's Dead"],a:1,d:2},{q:"Who directed A Nightmare on Elm Street 3: Dream Warriors?",o:["Wes Craven","Renny Harlin","Chuck Russell","Stephen Hopkins"],a:2,d:2},{q:"In Nightmare on Elm Street 4, what power does Alice develop as the Dream Master?",o:["She absorbs the dream powers of her friends as they die","She can pull Freddy out of dreams into the real world","She becomes invisible to Freddy whenever she sleeps","She can fly and teleport freely through the dreamscape"],a:0,d:2},{q:"Who directed A Nightmare on Elm Street 4: The Dream Master?",o:["Chuck Russell","Renny Harlin","Stephen Hopkins","Rachel Talalay"],a:1,d:2},{q:"In Freddy's Dead, what 3D sequence ends the film?",o:["The final battle where Freddy is destroyed in the real world","The entire origin story of Freddy Krueger's childhood years","Freddy killing a bus full of teenagers during their field trip","Freddy entering the Springwood high school during a big dance"],a:0,d:2},{q:"Who directed Wes Craven's New Nightmare?",o:["Chuck Russell","Renny Harlin","Rachel Talalay","Wes Craven"],a:3,d:2},{q:"What makes Wes Craven's New Nightmare different from all other Nightmare films?",o:["It stars real people playing themselves — the cast and crew of the original films","It takes place in outer space aboard an orbiting facility much like Jason X would later","It is entirely rendered as a stop motion animation feature using puppets made by Wes Craven","It features no appearance from Freddy Krueger at any point during its theatrical 112 minute runtime"],a:0,d:2},{q:"In Friday the 13th: The Final Chapter, what actor has an early role as a teen?",o:["Crispin Glover","Kevin Bacon Jr","Corey Feldman","Johnny Depp II"],a:0,d:1},{q:"What is the subtitle of Friday the 13th Part VII?",o:["Jason Lives","The New Blood","Jason Takes Manhattan","A New Beginning"],a:1,d:1},{q:"In Friday the 13th Part VII, what special ability does Tina have?",o:["Telepathy","Telekinesis","Pyrokinesis","Precognition"],a:1,d:1},{q:"What is the setting of Jason X (2002)?",o:["A space station in the future","A theme park on Halloween","An underground bunker complex","A deep sea research station"],a:0,d:1},{q:"In Friday the 13th (2009 remake), what is different about Jason's behavior?",o:["He is slower than usual","He runs and keeps a captive","He can teleport","He speaks for the first time"],a:1,d:1},{q:"What is the title of the film where Freddy and Jason fight each other?",o:["Freddy vs. Jason (2003)","Jason vs. Freddy (2001)","Monster Mash (2004)","Nightmare at Crystal Lake (2002)"],a:0,d:1},{q:"In Friday the 13th Part VI: Jason Lives, how is Jason resurrected?",o:["Tommy Jarvis accidentally revives him when a fence post is struck by lightning","A witch performs a dark ritual in the Crystal Lake woods and brings him back alive","A disaster at the Camp Forest Green chemical plant resurrects him with toxic waste","A cult of Jason worshipers sacrifices a local virgin to bring back their dark master"],a:0,d:2},{q:"Who directed Friday the 13th Part VI: Jason Lives?",o:["Joseph Zito","Tom McLoughlin","Rob Hedden","Danny Steinmann"],a:1,d:2},{q:"In Friday the 13th Part VIII, where does Jason travel to?",o:["New York City","Los Angeles","Miami beach","Chicago IL"],a:0,d:2},{q:"What is the twist ending of Friday the 13th: A New Beginning (Part V)?",o:["The killer is Roy Burns, a copycat paramedic","Mrs. Voorhees has been alive the whole time now","Jason Voorhees has a long-lost twin brother alive","Tommy Jarvis has slowly become the new Jason killer"],a:0,d:2},{q:"Who plays Jason Voorhees in the 2009 Friday the 13th remake?",o:["Kane Hodder","Ken Kirzinger","Derek Mears","C.J. Graham"],a:2,d:2},{q:"In Jason Goes to Hell, what unusual method does Jason use to move between bodies?",o:["He passes a demonic heart slug through their mouths","He possesses victims through telepathic mental contact","He merges with their shadows during the dead of night","He kills them and takes on their physical human form"],a:0,d:2},{q:"What famous prop is seen pulling Jason's mask into the ground at the end of Jason Goes to Hell?",o:["Michael Myers' knife","Pinhead's chains","Freddy Krueger's glove","The Necronomicon"],a:2,d:2},{q:"What is the title of the sequel to Child's Play where Tiffany becomes a doll?",o:["Seed of Chucky","Bride of Chucky","Child's Play 4","Curse of Chucky"],a:1,d:1}];
const Q5c29=[{q:"Who plays Andy Barclay in Child's Play 3?",o:["Alex Vincent","Justin Whalin","Devon Sawa","Andy Lawrence"],a:1,d:1},{q:"In Curse of Chucky (2013), how is the film connected to the original?",o:["It reveals Chucky had a connection to Nica's family before the original film","It is a full reboot that completely ignores every Chucky film that came before it","It is set in the distant future long after the events of the original Child's Play","It retells the same story from the perspective of the Barclay family dog named Rex"],a:0,d:2},{q:"In Cult of Chucky (2017), what new ability does Chucky demonstrate?",o:["He can possess multiple Chucky dolls at once","He becomes fully invisible to human beings","He can speak any language fluently without effort","He gains the ability to fly at high speeds around"],a:0,d:2},{q:"What streaming series continued the Chucky franchise from 2021?",o:["Chucky on USA Network and Syfy","Chucky on the Netflix streaming service","Chucky on NBC Peacock streaming app","Chucky on the Shudder horror service"],a:0,d:2},{q:"In Child's Play 3, where is Andy Barclay sent?",o:["A psychiatric hospital","A military academy","A foster home","A summer camp"],a:1,d:1},{q:"Who stars in The Texas Chainsaw Massacre 2 (1986) as the protagonist?",o:["Caroline Williams","Marilyn Burns Jr","Bill Moseley Sr.","Jim Siedow II"],a:0,d:1},{q:"Who plays Drayton Sawyer in The Texas Chainsaw Massacre 2?",o:["Jim Siedow","Bill Moseley","Bill Johnson","Dennis Hopper"],a:0,d:2},{q:"Who plays the Texas Ranger hunting Leatherface in Texas Chainsaw Massacre 2?",o:["Tommy Lee Jones","Dennis Hopper","Powers Boothe","James Earl Jones"],a:1,d:1},{q:"What is the name of Leatherface's brother with the metal plate in his head in Texas Chainsaw Massacre 2?",o:["Chop-Top","Drayton","Nubbins","Tex Sr"],a:0,d:1},{q:"What is the name of Leatherface in Texas Chainsaw Massacre 2 and beyond?",o:["Bubba Sawyer","Leatherface Sawyer","Junior Sawyer","Jed Sawyer"],a:0,d:2},{q:"In Leatherface: Texas Chainsaw Massacre III (1990), who has an early role?",o:["Matthew McConaughey","Viggo Mortensen","Renee Zellweger","Jennifer Aniston"],a:1,d:2},{q:"In Texas Chainsaw Massacre: The Next Generation (1994), which two future stars appear?",o:["Matthew McConaughey and Renée Zellweger","Brad Pitt in an early role and Angelina Jolie","Will Smith and Martin Lawrence in a small cameo","Tom Hanks and Meg Ryan in an unusual horror role"],a:0,d:1},{q:"In Hellraiser, who is the first person to solve the Lament Configuration in the film?",o:["Kirsty Cotton","Larry Cotton","Frank Cotton","Julia Cotton"],a:2,d:2},{q:"What is the subtitle of Hellraiser II?",o:["Hell on Earth","Hellbound","Deader","Hellseeker"],a:1,d:1},{q:"In Hellbound: Hellraiser II, who becomes a new Cenobite?",o:["Dr. Channard","Tiffany Nouvelle","Kirsty Cotton","Larry Channel"],a:0,d:2},{q:"What is Pinhead's real name and background before becoming a Cenobite?",o:["Elliott Spencer, a World War I soldier","Frank Cotton, a thrill-seeking drifter","Larry Cotton, a businessman and father","Julian Grey, a Victorian era magician"],a:0,d:2},{q:"In Hellraiser III: Hell on Earth, where is Pinhead trapped at the start?",o:["A sculpture called the Pillar of Souls","An ornate stained glass church window","A tall marble statue in an art gallery","A gilded mirror in a wealthy estate home"],a:0,d:2},{q:"How many Hellraiser films had been made by the end of 2023?",o:["8","10","11","12"],a:3,d:2},{q:"Who plays Pinhead in the 2022 Hellraiser reboot?",o:["Doug Bradley","Odessa A'zion","Jamie Clayton","Grace Zabriskie"],a:2,d:1},{q:"What is the Candyman's backstory in the 1992 film?",o:["A 19th century artist and son of a slave who was murdered by a racist mob","A 20th century jazz musician who was killed by a jealous rival in Chicago","A demon summoned by a voodoo ritual performed in New Orleans in the 1920s","A Civil War soldier whose spirit was trapped in his own sword by a witch's curse"],a:0,d:1},{q:"In Candyman (1992), what does the Candyman do to Helen's baby?",o:["He takes the baby to use in a ritual","He transforms the baby into a new spirit","He raises the baby as his dark apprentice","He protects the baby from the police force"],a:0,d:2},{q:"Who directed the 2021 Candyman sequel?",o:["Jordan Peele","Nia DaCosta","Barry Jenkins","Lena Waithe"],a:1,d:1},{q:"What connects the 2021 Candyman to the original 1992 film?",o:["It is a direct sequel following the original's events and mythology","It is a full reboot with no connection to the 1992 Bernard Rose film","It is set in a totally different city with entirely unrelated new characters","It retells the exact same story but from a different character's perspective"],a:0,d:2},{q:"In the 2021 Candyman, who becomes the new Candyman?",o:["Anthony McCoy, an artist whose life was touched by the original Candyman events","William Burke, a laundromat worker who inherited the hook from his grandfather years","Helen Lyle's own biological son who had been hidden from the world by her family","Brianna Cartwright, an art gallery owner drawn into the dark mythology one chilly night"],a:0,d:2},{q:"In The Hills Have Eyes (1977), what happened to the mutant family to make them the way they are?",o:["Nuclear testing in the Nevada desert affected generations of people who refused to leave","A government experiment on human subjects went badly wrong at a secret desert facility","An ancient Native American curse placed on trespassers who crossed onto sacred grounds","A toxic chemical spill from a nearby uranium mine mutated generations of local miners"],a:0,d:2},{q:"What is the name of the main mutant villain in The Hills Have Eyes 1977?",o:["Jupiter","Pluto","Saturn","Mercury"],a:0,d:2},{q:"In the 2006 Hills Have Eyes remake, how does the family become stranded?",o:["They are lured off-road and their trailer is wrecked by a spike strip","Their RV engine overheats suddenly in the middle of the desert at midday","They follow a suspicious hitchhiker to a remote abandoned mining town camp","Their map is stolen by a gas station attendant early on in the film's opening"],a:0,d:2},{q:"What year was the original Wrong Turn released?",o:["2001","2002","2003","2004"],a:2,d:1},{q:"In Wrong Turn (2003), who plays the lead character Chris Flynn?",o:["Desmond Harrington","Eliza Dushku Jr.","Kevin Zegers Sr.","Jeremy Sisto II"],a:0,d:2},{q:"In Wrong Turn 2: Dead End, who hosts the survival reality show?",o:["Robert Englund","Henry Rollins","Tony Todd","Kane Hodder"],a:1,d:2},{q:"What fundamentally changed about the killers in the 2021 Wrong Turn reboot?",o:["They became a hidden mountain commune called The Foundation instead of cannibals","They were revealed to be shapeshifting aliens hiding in human form in the mountains","They became sympathetic heroes protecting the wilderness from corporate development","They became a government covert special forces unit testing tourist reactions for research"],a:0,d:1},{q:"What is the tagline of the Hatchet franchise?",o:["It's not a sequel, it's not a remake","It is real old school American horror","Fear the Louisiana swamp at all cost","The last true slasher franchise begins"],a:0,d:2},{q:"In Hatchet, what caused Victor Crowley's death as a child?",o:["His father accidentally hit him in the face with a hatchet while trying to rescue him from a burning cabin fire at home","He drowned in the Louisiana swamp after cruel local boys pushed him off of a tall wooden pier one hot summer day","He was killed by visiting campers who mistook him for a dangerous wild animal prowling near their tents at night","He fell from a tall tree in the Louisiana bayou while trying to escape older schoolboys who had chased him away"],a:0,d:2},{q:"What horror icon appears as the swamp tour guide in the original Hatchet?",o:["Both Robert Englund and Tony Todd","Just Robert Englund in a small cameo","Just Tony Todd with no other horror","Kane Hodder with the other two men"],a:0,d:2},{q:"What year was the original Terrifier released?",o:["2014","2015","2016","2017"],a:2,d:1},{q:"Who created Art the Clown?",o:["Damien Leone","Adam Green","Ti West Sr.","Joe Lynch II"],a:0,d:1},{q:"In Terrifier 2, what is the name of the new character Art targets?",o:["Allie","Victoria","Sienna","Dawn"],a:2,d:1},{q:"What is unusual about Terrifier 2's runtime?",o:["It is 138 minutes — unusually long for a slasher","It is under 90 minutes which is standard length","It is over three full hours in its director's cut","It is exactly 70 minutes making it feel very short"],a:0,d:2},{q:"In Terrifier 3, what holiday does Art the Clown target?",o:["Halloween","Thanksgiving","Christmas","New Year's Eve"],a:2,d:1},{q:"How did Terrifier 2 primarily find its audience?",o:["Through word of mouth and viral social media posts about its extreme content","A major Hollywood studio gave it a blockbuster marketing campaign that summer","It debuted directly on a major streaming service reaching millions overnight quickly","The film festival circuit built early critical buzz that spread to horror fans slowly"],a:0,d:2},{q:"In Jeepers Creepers, how often does The Creeper wake up to feed?",o:["Every 23 years for 23 days","Every decade for a full year","Every full moon in the autumn","Every summer solstice for weeks"],a:0,d:1},{q:"What does The Creeper in Jeepers Creepers eat?",o:["Specific body parts he needs to regenerate himself","Blood only which he stores in jars at his lair","Living souls which he absorbs into his dark body","Any human flesh without any particular preference at all"],a:0,d:1},{q:"In Jeepers Creepers, how do siblings Trish and Darry first encounter The Creeper?",o:["They see him dumping bodies down a pipe near a church","He ambushes them at an isolated rural gas station at night","They accidentally stumble upon his underground lair one day","He attacks their car while they drive down a desolate highway"],a:0,d:2},{q:"In The Purge: Anarchy (2014), who is the main character trying to rescue his family?",o:["Frank Grillo","Ethan Hawke","Edwin Hodge","Mykelti Williamson"],a:0,d:2},{q:"What is the name of the main character Frank Grillo plays in The Purge: Anarchy?",o:["Leo Barnes","Jack Stanfield","Frank Castle","Ray Merrimen"],a:0,d:2},{q:"In The First Purge (2018), where does the first Purge take place?",o:["Staten Island as a test location","Washington DC inside the Capitol","All of America at once by surprise","Chicago in a limited experiment"],a:0,d:1},{q:"What is The Forever Purge (2021) about?",o:["Purgers who refuse to stop killing after the Purge ends","A single family fights to survive one long Purge night","The original 1970s origin story of the Purge being created","A politician begins a campaign to permanently abolish the Purge"],a:0,d:2},{q:"What is the name of the killer in The Hills Have Eyes (1977)?",o:["Jupiter","Saturn","Mars","Pluto"],a:0,d:1},{q:"In The People Under the Stairs (1991), who are the main villains?",o:["A wealthy incestuous couple who terrorize their tenants","A cult leader and his devoted followers run a tenement home","A rogue police officer who slowly goes mad in a rented home","A vengeful ghost family that haunts their old house after death"],a:0,d:1},{q:"Who plays the boy hero Fool in The People Under the Stairs?",o:["Brandon Adams","Ving Rhames","Everett McGill","A. J. Langer"],a:0,d:2},{q:"What is the basic premise of Wes Craven's Deadly Friend (1986)?",o:["A boy implants a robot's computer chip into his dead girlfriend's brain","A killer robot escapes from a lab and begins hunting an American family","A scientist creates a monster in a high school research basement laboratory","A haunted suburban house awakens a dormant mechanical creature from the 1950s"],a:0,d:2},{q:"In Wes Craven's Swamp Thing (1982), who plays Dr. Alec Holland?",o:["Ray Wise","Adrienne Barbeau","Louis Jourdan","Dick Durock"],a:0,d:2},{q:"What is the name of the Firefly family's home in House of 1000 Corpses?",o:["The Murder House","Captain Spaulding's Funhouse","The Firefly Farm","Murder Ride"],a:2,d:2},{q:"What song plays over the climax of The Devil's Rejects?",o:["Free Bird by Lynyrd Skynyrd","Simple Man by Lynyrd Skynyrd","Sweet Home Alabama by Lynyrd Skynyrd","That Smell by Lynyrd Skynyrd"],a:0,d:2},{q:"Who plays Baby Firefly in House of 1000 Corpses and The Devil's Rejects?",o:["Sherri Moon Zombie","Sid Haig Jr as baby","Karen Black as baby","Bill Moseley cameo"],a:0,d:1},{q:"What is 31 (2016) about?",o:["Carnival workers are captured and must survive killers in a game called 31","A family of carnival performers hunts tourists visiting their traveling show","A killer clown escapes from a carnival and begins a bloody rampage in town","A haunted carnival ride transports its riders into a hellish demonic dimension"],a:0,d:2},{q:"In 3 From Hell (2019), which Firefly family member is introduced for the first time?",o:["Winslow Foxworth Coltrane","Billy Ray Snapper Sr","Rondo Thompson II","Tex Otis Firefly"],a:0,d:2},{q:"What is the name of the cult in Ti West's The Sacrament (2013)?",o:["Eden Parish","Heaven's Gate","The Foundation","Jonestown"],a:0,d:2},{q:"What is Ti West's The House of the Devil (2009) set during?",o:["The 1980s — it mimics the style of early 80s horror films","The 1970s — during the golden age of exploitation movies","The 1990s — just before Scream changed the genre forever","The present day — with retro styling throughout its look"],a:0,d:2},{q:"In X (2022), what are the film crew shooting on Pearl's farm?",o:["A slasher film","An adult film","A music video","A documentary"],a:1,d:1},{q:"In Mike Flanagan's Hush (2016), what makes the main character uniquely vulnerable?",o:["She is deaf and mute","She is totally blind","She has no phone","She is paralyzed"],a:0,d:1},{q:"What Stephen King novel did Mike Flanagan adapt in Gerald's Game (2017)?",o:["Gerald's Game","Pet Sematary","Doctor Sleep","The Shining II"],a:0,d:1},{q:"In Flanagan's Oculus (2013), what does the Lasser Glass do?",o:["It kills anyone who looks into it and corrupts the minds of those nearby","It summons demons from another dimension when lit by candlelight at night","It shows visions of the past lives of everyone who owned it over the years","It reveals visions of the future to anyone brave enough to stare into the glass"],a:0,d:2},{q:"What country is The Descent set in?",o:["USA","Canada","Scotland","England"],a:3,d:2},{q:"In The Descent (2005), what are the creatures that attack the women called?",o:["Wraiths","Crawlers","Reapers","Tunnelers"],a:1,d:1},{q:"What is the original UK ending of The Descent that differs from the US release?",o:["Sarah escapes but discovers she is still in the cave — her vision of escape was a hallucination","Sarah kills all of the Crawlers one by one in a final battle deep beneath the North Carolina mountains","Sarah and Juno survive the cave together and drive away from the forest in silence toward the hospital","Sarah escapes the caves and returns to her family home to find her dead husband alive and waiting for her"],a:0,d:2},{q:"In Eden Lake (2008), what makes the film particularly disturbing?",o:["The killers are a group of ordinary British teenagers","The monsters in the film are revealed to be supernatural","The killer is the main victim's own husband the whole time","The setting of the lake is a haunted place with a dark past"],a:0,d:1},{q:"What country made Eden Lake (2008)?",o:["Australia","USA","UK","Canada"],a:2,d:1},{q:"Who stars in Eden Lake?",o:["Michael Fassbender and Kelly Reilly","Sam Neill and Nicole Kidman","Elijah Wood and Frodo Baggins","Hugh Jackman and Naomi Watts"],a:0,d:2},{q:"What is the premise of Hostel (2005)?",o:["Wealthy clients pay to torture and kill tourists in a secret Eastern European facility","A lone maniac targets backpackers staying at various youth hostels across Western Europe","A serial killer stalks youth hostels all across Europe leaving a bloody trail in each city","A haunted hostel in an ancient Eastern European village kills its guests one by one at night"],a:0,d:1},{q:"Who directed Hostel (2005)?",o:["James Wan","Rob Zombie","Eli Roth","Ti West"],a:2,d:1},{q:"What country is Hostel primarily set in?",o:["Germany","Slovakia","Czech Republic","Romania"],a:1,d:2},{q:"What is the sequel Hostel: Part II (2007) notable for?",o:["It follows female victims and shows the client side of the Elite Hunting organization","It is set across many Asian countries instead of staying in the Eastern European setting","It has a far higher body count than the original Hostel film and broader graphic content","It is set in rural America and shows the expansion of Elite Hunting to American territories"],a:0,d:2},{q:"What year was Paranormal Activity given its wide theatrical release?",o:["2006","2007","2008","2009"],a:3,d:1},{q:"How much did Paranormal Activity cost to make?",o:["$100,000","$500,000","About $15,000","About $1 million"],a:2,d:2},{q:"What is the found footage style used in Paranormal Activity?",o:["Home video cameras placed around the house at night","Grainy convenience store security footage throughout","A single handheld handicam used by the main character","Footage from discovered police evidence videos for real"],a:0,d:1},{q:"Who directed Paranormal Activity?",o:["James Wan","Jason Blum","Oren Peli","Brad Anderson"],a:2,d:2},{q:"In It Follows (2014), how is the deadly entity passed from person to person?",o:["By making eye contact","Through sexual contact","By touching them","By saying their name"],a:1,d:1},{q:"What makes the entity in It Follows unusual compared to other slasher killers?",o:["It always walks slowly but never stops following until it catches its target","It is completely invisible to everyone except its very next intended target alone","It can only be seen by very young children under the age of ten years old in total","It only kills at night and can be stopped entirely by simply locking doors during the day"],a:0,d:1},{q:"What city is It Follows set in?",o:["Chicago","Los Angeles","Detroit","Pittsburgh"],a:2,d:2},{q:"In Get Out (2017), what happens to Black people who are taken to the Armitage estate?",o:["Their bodies are used to transplant the consciousness of wealthy white people","They are killed so their organs can be harvested for sale on a black market","They are kept enslaved as servants on the grounds of the Armitage family estate","They are subjected to an array of medical experiments at a secret basement lab facility"],a:0,d:1},{q:"What is the name of the hypnotic state in Get Out called?",o:["The Sunken Place","The Dark Place","The Void Room","The Deep Zone"],a:0,d:1},{q:"Who plays Chris Washington in Get Out?",o:["LaKeith Stanfield","Daniel Kaluuya","Lil Rel Howery","Marcus Henderson"],a:1,d:1},{q:"What does Chris's friend Rod correctly identify is happening at the Armitage house?",o:["A body-snatching operation","A sex trafficking network","Simple straight murder cover","A cult ritual sacrifice day"],a:0,d:2},{q:"In Ready or Not (2019), what game does Grace have to survive?",o:["Hide-and-Seek","Capture Flag","Blind Tag","Chess Game"],a:0,d:1},{q:"Why does the Le Domas family hunt Grace in Ready or Not?",o:["A pact with the devil — they must sacrifice a new family member who picks the wrong card or their whole family will die","A centuries-old tradition handed down across generations of Le Domas family members who always celebrate newlyweds by hunting a bride","A financial curse placed on the gaming dynasty by a jealous rival — they must kill a bride-to-be every decade to keep their casino empire","A ritual from the family's founding ancestors who were occult practitioners — each generation must hunt a wedded outsider on the wedding night"],a:0,d:2},{q:"What happens to the Le Domas family at the end of Ready or Not?",o:["They all explode at dawn when the pact is broken","The police arrive at the manor and arrest them all","Grace systematically hunts and kills every last one","They commit a mass suicide inside the old manor home"],a:0,d:2},{q:"In Fresh (2022), what does Noa discover about her new boyfriend Steve?",o:["He harvests and sells human meat to wealthy clients","He is a serial killer who targets women working in tech","He is already married and has been leading a double life","He is a cannibal who eats only his own personal victims"],a:0,d:1},{q:"Who plays Steve in Fresh (2022)?",o:["Oscar Isaac","Sebastian Stan","Tom Pelphrey","Andrew Garfield"],a:1,d:2},{q:"What is the twist ending of Bodies Bodies Bodies (2022)?",o:["David accidentally killed himself and there was no murderer — paranoia killed everyone else","The host of the party was the real killer and had planned each death throughout the entire night","There was one real killer hiding in plain sight among the group the entire time unnoticed by them all","A reality show prank gone horribly wrong was the cause of every death during the wild pandemic weekend"],a:0,d:2},{q:"Who directed Bodies Bodies Bodies (2022)?",o:["Ari Aster","Jordan Peele","Halina Reijn","Karyn Kusama"],a:2,d:2},{q:"In Barbarian (2022), what does Tess discover in the basement of the Airbnb?",o:["A hidden tunnel system and evidence of something living beneath the house","A secret laboratory where past tenants had conducted human experimentation","A cache of firearms and knives hidden inside the walls of the old basement","A dead body concealed inside a large chest freezer under a shelf of canned goods"],a:0,d:1},{q:"Who directed Barbarian (2022)?",o:["David Robert Mitchell","Zach Cregger","Justin Benson","Mike Flanagan"],a:1,d:2},{q:"What is unique about Mia Goth's performance in X (2022)?",o:["She plays both Maxine the young heroine and Pearl the elderly killer using extensive prosthetics","She plays identical twin sisters who are on opposite sides of the central 1970s Texas massacre in the film","She directed the entire film herself despite having no previous directing credits across her whole career","She improvised all of her dialogue across both characters without any scripted lines given by Ti West"],a:0,d:2},{q:"In Pearl (2022), what is Pearl's obsession that drives the film?",o:["Becoming a famous performer and escaping her farm life","Taking bloody revenge on the family who wronged her mother","Escaping Texas to start a new religious cult out in California","Killing her entire family and burying them all in their own barn"],a:0,d:1},{q:"What decade is MaXXXine (2024) set in?",o:["The 1970s","The 1980s","The 1990s","The 2000s"],a:1,d:1},{q:"Who is the Night Stalker in MaXXXine?",o:["A reference to real-life killer Richard Ramirez who terrorized Los Angeles in the 1980s","A reference to the fictional serial killer invented by author Robert Bloch for his 1970s horror novels","A hired assassin sent by Maxine's wealthy father to drag her back home to Texas from Los Angeles city","A made-up character who leads the production company cult behind all of the murders happening in the film"],a:0,d:2},{q:"What is the premise of Five Nights at Freddy's (2023)?",o:["A security guard discovers the animatronic characters at Freddy Fazbear's are possessed by the souls of murdered children","A man in a mascot costume stalks and attacks children at a haunted birthday party restaurant in a small rural American town","A corporation begins manufacturing a new line of killer robots and sells them to restaurants across the country before they escape","A reopened family pizzeria turns out to be an ancient portal to an evil demonic realm that has been sealed by the original owner"],a:0,d:1},{q:"Who plays the security guard Mike Schmidt in Five Nights at Freddy's?",o:["Josh Hutcherson","Josh Gad Jr.","Mark Hamill Jr.","Jack Black II"],a:0,d:1},{q:"In M3GAN (2023), what is M3GAN?",o:["An AI-powered robotic doll that becomes dangerously protective of the child she is bonded to","A possessed antique porcelain doll that spreads a deadly ghostly curse through any family she enters","A government made killer android sent to eliminate a very specific scientist targeted by a secret program","A haunted collectible toy from the 1980s that reactivates after being stored in a basement for over thirty years"],a:0,d:1},{q:"Who directed M3GAN (2023)?",o:["Gerard Johnstone","James Wan Jr.","Jason Blum Sr","Lee Cronin II"],a:0,d:2},{q:"Who directed Thanksgiving (2023)?",o:["James Wan","Rob Zombie","Eli Roth","Ti West"],a:2,d:1},{q:"What was Thanksgiving (2023) based on?",o:["A fake Grindhouse trailer Eli Roth made in 2007","A 1980s slasher novel by the writer Peter Straub","A true crime case from colonial Plymouth Colony","A short film that played at Sundance several years"],a:0,d:1},{q:"What is the killer's name in Thanksgiving (2023)?",o:["The Carver","John Carver","The Pilgrim","The Harvester"],a:1,d:1},{q:"Who wrote the screenplay for The Slumber Party Massacre (1982)?",o:["Amy Holden Jones","Rita Mae Brown","Carol J. Clover","Katt Shea"],a:1,d:2},{q:"What is the name of the killer in The Slumber Party Massacre?",o:["The Driller Killer — Russ Thorn","The Power Tool Killer — Thorn","The Slumber Party Killer is Roy","Billy Driller — a copycat killer"],a:0,d:2},{q:"In Tourist Trap (1979), what special power does the killer Mr. Slausen possess?",o:["Telekinesis — he can move objects and animate mannequins with his mind","Complete invisibility whenever he stands still and holds his breath for long","Superhuman strength that lets him throw grown adult victims across rooms","Immortality from a brief occult pact signed with a demon when he was young"],a:0,d:2},{q:"Who plays the villain in Tourist Trap (1979)?",o:["Vincent Price","Donald Pleasence","Chuck Connors","Robert Englund"],a:2,d:2},{q:"In Maniac (1980), what does killer Frank Zito do to his victims after killing them?",o:["Scalps them and puts the scalps on mannequins in his apartment","Preserves his victims in formaldehyde jars hidden in a closet","Photographs their bodies and hangs prints on his apartment walls","Buries them in a basement crawlspace of his old apartment building"],a:0,d:2},{q:"What city is Maniac (1980) set in?",o:["New York City","San Francisco","Philadelphia","Los Angeles"],a:0,d:1},{q:"In Pieces (1982), what is the killer collecting?",o:["Body parts to assemble into a human jigsaw puzzle","Severed hands to preserve in large glass display jars","Human teeth to string together into a long necklace","Eyeballs that he keeps inside small crystal display jars"],a:0,d:2},{q:"What country made Pieces (1982)?",o:["Spain","Italy","USA","UK"],a:0,d:2},{q:"In My Bloody Valentine (1981), who is the killer actually revealed to be?",o:["Harry Warden","Tom Hanniger","Axel Palmer","Chief Newby"],a:2,d:2},{q:"What is unique about the My Bloody Valentine 3D (2009) remake?",o:["It was shot in digital 3D unlike older polarized 3D processes","It is the first ever slasher remake released to theaters in wide release","It holds the single highest body count in any American slasher ever made","It was controversially released to theaters with no MPAA rating of any kind"],a:0,d:2},{q:"What Canadian city is Happy Birthday to Me (1981) set in?",o:["Toronto","Montreal","Vancouver","Ottawa"],a:0,d:2},{q:"What is the famous image on the poster for Happy Birthday to Me?",o:["A shish kebab being forced through someone's mouth","A killer in a clown mask holding a bloody machete","A birthday cake topped with a butcher knife and candles","A human skull with candles forming a birthday crown above"],a:0,d:2},{q:"In Sleepaway Camp 2, what is Angela's job at the camp?",o:["A camper","A cook","A counselor","The camp director"],a:2,d:1},{q:"Who plays Angela in Sleepaway Camp 2 and 3?",o:["Pamela Springsteen","Felissa Rose Jr.","Karen Fields Sr","Susan Tyrrell II"],a:0,d:2},{q:"What is the tone of Sleepaway Camp 2 compared to the original?",o:["Much more comedic and self-aware","Much darker and more serious tone","Shot in a new found footage style","Identical in tone to the first film"],a:0,d:1},{q:"In Blood Rage (1987), what is the central twist?",o:["One twin committed the murders and framed his brother who spent years in a psychiatric hospital","The mother of the family was secretly the real killer behind every murder that took place in the town","The killer turned out to have been dead the entire time and all the events were just a violent hallucination","The protagonist's estranged father returned home after decades to carry out revenge against the entire family"],a:0,d:2},{q:"What holiday is Blood Rage set during?",o:["Halloween","Christmas","Thanksgiving","New Year's Eve"],a:2,d:2},{q:"In Stage Fright (1987), what does the killer wear as a mask?",o:["A skull","A giant owl head","A clown face","A blank white mask"],a:1,d:1},{q:"What is the killer locked in at the start of Stage Fright before escaping?",o:["A mental institution","An old state prison","A padded holding cell","An armored ambulance"],a:0,d:2},{q:"In The Prowler (1981), who plays the killer?",o:["The film never reveals the killer's identity clearly","A returning World War II veteran","A local sheriff","A gardener"],a:1,d:2},{q:"What special effects artist created the kills in The Prowler?",o:["Rick Baker","Rob Bottin","Tom Savini","Greg Nicotero"],a:2,d:2},{q:"Where is Intruder (1989) primarily set?",o:["A hospital","A supermarket","A shopping mall","A school"],a:1,d:2},{q:"Who has a cameo appearance in Intruder (1989)?",o:["Bruce Campbell and Sam Raimi","Stephen King and Clive Barker","Tobe Hooper and John Carpenter","Wes Craven and Joe Dante Jr."],a:0,d:2},{q:"What school event does Slaughter High center around?",o:["A class reunion held at the abandoned school","A homecoming football game at the stadium","A graduation ceremony held at the stadium","A prom night held at the abandoned old gym"],a:0,d:1},{q:"What is the killer's name in Slaughter High?",o:["Marty Rantzen","Billy Warden","Roy Hawkins","Tommy Evans"],a:0,d:2},{q:"In The Loved Ones (2009), what does Lola do to the boy who rejected her invitation to prom?",o:["She kidnaps and tortures him with her father's help in a deranged prom of her own","She relentlessly stalks him for months through his high school and beyond into college","She frames him for a series of crimes he didn't commit to ruin his entire reputation","She poisons him slowly over several weeks with a homemade concoction from her garden"],a:0,d:1},{q:"What country made The Loved Ones (2009)?",o:["Australia","New Zealand","Canada","USA"],a:0,d:1},{q:"Who directed High Tension (2003)?",o:["Pascal Laugier","Xavier Gens","Julien Maury","Alexandre Aja"],a:3,d:2},{q:"What is the controversial twist at the end of High Tension?",o:["Marie herself is the killer — she has a split personality","The family was never real — they were hallucinations alone","The killer turned out to be a vengeful ghost from a past life","The entire film is revealed to be a dream sequence at the end"],a:0,d:2},{q:"What country made Inside (2007)?",o:["Belgium","Spain","France","Italy"],a:2,d:1},{q:"In Inside (2007), why does the mysterious woman want what she wants from the pregnant woman?",o:["The woman was in an accident that killed the attacker's husband — she wants the baby because she lost her own","The attacker was once the woman's midwife and became obsessed with delivering this particular child due to its rare traits","The attacker belongs to a small Parisian cult that believes the baby is the reincarnation of their long-dead spiritual leader","The attacker was paid by the woman's estranged mother-in-law to take the baby away from her to raise it in southern France"],a:0,d:2},{q:"Who directed Martyrs (2008)?",o:["Alexandre Aja","Xavier Gens","Pascal Laugier","Julien Maury and Alexandre Bustillo"],a:2,d:2},{q:"What does the cult in Martyrs (2008) believe extreme suffering will reveal?",o:["A glimpse of what lies beyond death","A path to achieving personal immortality","The secret location of heaven's gateway","Powerful supernatural abilities on earth"],a:0,d:2},{q:"Who directed Audition (1999)?",o:["Park Chan-wook","Kim Jee-woon","Takashi Miike","Hideo Nakata"],a:2,d:2},{q:"In Audition (1999), what does Asami say repeatedly while torturing Shigeharu?",o:["'Kiri kiri kiri' — a word meaning 'cut'","'Shinu shinu shinu' meaning die in Japanese","'Itai itai itai' meaning it hurts in Japanese","'Aishiteru' — the phrase means I love you"],a:0,d:2},{q:"Who directed I Saw the Devil (2010)?",o:["Park Chan-wook","Bong Joon-ho","Kim Jee-woon","Na Hong-jin"],a:2,d:2},{q:"In I Saw the Devil, who is the main character hunting the killer?",o:["A secret service agent whose fiancée was killed","A retired homicide detective with no other ties","A vigilante with no personal connection whatsoever","A police detective assigned to the case officially"],a:0,d:2},{q:"Who directed the original Suspiria (1977)?",o:["Mario Bava","Lucio Fulci","Dario Argento","Michele Soavi"],a:2,d:1},{q:"In Suspiria (1977), what is the Freiburg dance academy secretly run by?",o:["A serial killer","A coven of witches","A satanic cult","Nazi scientists"],a:1,d:1},{q:"What is the Suspiria (2018) remake notable for?",o:["It is a loose reimagining directed by Luca Guadagnino set in 1970s Berlin","It is a frame-for-frame exact remake of the original 1977 Dario Argento film","It is an animated horror film loosely inspired by the themes of the original film","It is a direct sequel to the original that reunites members of the original cast"],a:0,d:2},{q:"What does the title Suspiria mean?",o:["Sighs — from a Thomas de Quincey essay","Screams — from an ancient Latin prayer text","Whispers — from a classical Italian opera line","Shadows — from a forgotten medieval Latin poem"],a:0,d:2},{q:"In Opera (1987), what does the killer force the heroine to watch murders with?",o:["Needles taped under her eyes so she cannot blink","Tape holding her eyelids open the whole time","A mechanical device that keeps her eyes awake","She watches willingly despite being terrified"],a:0,d:2},{q:"Who directed Opera (1987)?",o:["Mario Bava","Michele Soavi","Dario Argento","Lucio Fulci"],a:2,d:2},{q:"In Dario Argento's Phenomena (1985), what unusual ability does Jennifer have?",o:["She can communicate with and control insects","She can see visions of the killer's future kills","She possesses superhuman speed and pure strength","She is completely immune to the killer's attacks"],a:0,d:2},{q:"Who plays Jennifer in Argento's Phenomena?",o:["Asia Argento","Jessica Harper","Jennifer Connelly","Daria Nicolodi"],a:2,d:2},{q:"What slasher film did Mario Bava's Bay of Blood (1971) directly inspire?",o:["Halloween","The Texas Chain Saw Massacre","Friday the 13th","Black Christmas"],a:2,d:2}];
...
export default function App() {
  ...
  return (
    <div style={{width:"100%",minHeight:"100vh",color:"#fff",position:"relative",overflow:"auto",paddingBottom:"120px",fontFamily:"'Inter',sans-serif"}}>
      ...
      {/* TITLE SCREEN */}
        ...
        {scr === "about" && (
          <div style={{flex:1,display:"flex",flexDirection:"column",alignItems:"center",padding:"40px 24px 30px",animation:"fi 0.5s",overflowY:"auto"}}>
            ...
            <button onClick={() => { Au.p("close"); setScr(prevScr && prevScr !== "about" ? prevScr : "title"); }} style={{...b2,marginTop:20,fontSize:13,padding:"10px 24px"}}>{prevScr === "game" ? "← Back to Game" : "Run Home"}</button>
          </div>
        )}
        ...
        {scr === "bd" && (
          <div style={{flex:1,display:"flex",flexDirection:"column",paddingTop:60,paddingBottom:30,animation:"fi 0.6s"}}>
            ...
            <button onClick={() => { Au.p("close"); setScr(prevScr && prevScr !== "bd" ? prevScr : "title"); }} style={{...b2,margin:"18px auto 0"}}>{prevScr === "game" ? "← Back to Game" : "Run Home"}</button>
          </div>
        )}
